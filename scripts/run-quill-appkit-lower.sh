...
TOOL_PACKAGE_DIR="${QUILLUI_APPKIT_LOWER_PACKAGE_DIR:-$ROOT_DIR/.build/quill-appkit-lower-package-$TOOL_CACHE_KEY}"
TOOL_SCRATCH_PATH="${QUILLUI_APPKIT_LOWER_SCRATCH_PATH:-$ROOT_DIR/.build/quill-appkit-lower-tool-$TOOL_CACHE_KEY}"
