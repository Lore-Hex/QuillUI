...
AUTH_STATUS_DETAIL_BOOKMARK_POINTS="${QUILLUI_ICECUBES_VISUAL_AUTH_STATUS_DETAIL_BOOKMARK_POINTS:-$AUTH_STATUS_DETAIL_SECONDARY_BOOKMARK_X,432 568,432 600,432 $AUTH_STATUS_DETAIL_SECONDARY_BOOKMARK_X,444 568,444 600,444 $AUTH_STATUS_DETAIL_SECONDARY_BOOKMARK_X,$AUTH_STATUS_DETAIL_SECONDARY_BOOKMARK_Y 568,$AUTH_STATUS_DETAIL_SECONDARY_BOOKMARK_Y 600,$AUTH_STATUS_DETAIL_SECONDARY_BOOKMARK_Y $AUTH_STATUS_DETAIL_SECONDARY_BOOKMARK_X,170 568,170 600,170}"
