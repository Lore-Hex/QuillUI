...
AUTH_SETTINGS_DISPLAY_Y="${QUILLUI_ICECUBES_VISUAL_AUTH_SETTINGS_DISPLAY_Y:-365}"
...
AUTH_SETTINGS_DISPLAY_FONT_SCALE_END_X="${QUILLUI_ICECUBES_VISUAL_AUTH_SETTINGS_DISPLAY_FONT_SCALE_END_X:-620}"
AUTH_SETTINGS_DISPLAY_FONT_SCALE_Y="${QUILLUI_ICECUBES_VISUAL_AUTH_SETTINGS_DISPLAY_FONT_SCALE_Y:-592}"
...
AUTH_SETTINGS_DISPLAY_SYSTEM_COLOR_Y="${QUILLUI_ICECUBES_VISUAL_AUTH_SETTINGS_DISPLAY_SYSTEM_COLOR_Y:-293}"
...
AUTH_COMPOSER_TYPE_Y="${QUILLUI_ICECUBES_VISUAL_AUTH_COMPOSER_TYPE_Y:-95}"
AUTH_COMPOSER_AFTER_TYPE_SETTLE_SECONDS="${QUILLUI_ICECUBES_VISUAL_AUTH_COMPOSER_AFTER_TYPE_SETTLE_SECONDS:-2.5}"
AUTH_COMPOSER_SEND_X="${QUILLUI_ICECUBES_VISUAL_AUTH_COMPOSER_SEND_X:-623}"
AUTH_COMPOSER_SEND_Y="${QUILLUI_ICECUBES_VISUAL_AUTH_COMPOSER_SEND_Y:-29}"
...
scroll_authenticated_settings_content() {
  ...
  case "$clicks" in
    ''|*[!0-9]*)
      echo "QUILLUI_ICECUBES_VISUAL_AUTH_SETTINGS_DISPLAY_SCROLL_CLICKS must be a non-negative integer, got: $clicks" >&2
      exit 2
      ;;
  esac
