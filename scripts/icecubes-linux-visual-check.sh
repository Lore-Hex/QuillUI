...
AUTH_STATUS_DETAIL_BOOKMARK_X="${QUILLUI_ICECUBES_VISUAL_AUTH_STATUS_DETAIL_BOOKMARK_X:-461}"
AUTH_STATUS_DETAIL_BOOKMARK_Y="${QUILLUI_ICECUBES_VISUAL_AUTH_STATUS_DETAIL_BOOKMARK_Y:-462}"
AUTH_STATUS_DETAIL_BOOKMARK_POINTS="${QUILLUI_ICECUBES_VISUAL_AUTH_STATUS_DETAIL_BOOKMARK_POINTS:-$AUTH_STATUS_DETAIL_BOOKMARK_X,$AUTH_STATUS_DETAIL_BOOKMARK_Y 474,$AUTH_STATUS_DETAIL_BOOKMARK_Y 448,$AUTH_STATUS_DETAIL_BOOKMARK_Y $AUTH_STATUS_DETAIL_BOOKMARK_X,444 474,444 $AUTH_STATUS_DETAIL_BOOKMARK_X,170 474,170}"
...
count_authenticated_status_detail_bookmark_actions() {
  count_app_log_occurrences "$AUTH_STATUS_DETAIL_BOOKMARK_POST_LOG"
}
...
click_authenticated_status_detail_bookmark_action() {
  ...
  for point in $AUTH_STATUS_DETAIL_BOOKMARK_POINTS; do
    if [[ "$point" != *,* ]]; then
      echo "Invalid QUILLUI_ICECUBES_VISUAL_AUTH_STATUS_DETAIL_BOOKMARK_POINTS entry: $point" >&2
      exit 2
    fi
    point_x="${point%,*}"
    point_y="${point#*,}"
