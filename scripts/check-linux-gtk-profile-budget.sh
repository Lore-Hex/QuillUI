...
MAX_CPU_PCT="${QUILLUI_BACKEND_PROFILE_MAX_CPU_PCT:-${QUILLUI_GTK_PROFILE_MAX_CPU_PCT:-25}}"
MAX_RSS_KB="${QUILLUI_BACKEND_PROFILE_MAX_RSS_KB:-${QUILLUI_GTK_PROFILE_MAX_RSS_KB:-300000}}"
MAX_STARTUP_MS="${QUILLUI_BACKEND_PROFILE_MAX_STARTUP_MS:-${QUILLUI_GTK_PROFILE_MAX_STARTUP_MS:-5000}}"
CSV_PATH=""
