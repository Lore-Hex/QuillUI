...
struct QuillDataSourceLoweringTests {
    ...
    func visualSmokeExposesOptInMacReferenceLandmarks() throws {
        ...
        #expect(interactionScript.contains("scroll_clicks=\"${QUILLUI_BACKEND_SCROLL_CLICKS:-1200}\""))
        #expect(interactionScript.contains("xdotool click --repeat \"$scroll_clicks\" --delay 20 5"))
    ...
    func swiftOpenUIGTKPatchKeepsEnchantedFixesGeneric() throws {
        ...
        #expect(patchedRenderer.contains("remainingTicks: Int = 180, remainingTotalTicks: Int = 600"))
        ...
        #expect(patchedRenderer.contains("if applied { return true }"))
        #expect(patchedRenderer.contains("let applied = gtkApplyScrollTo(context.target, anchor: context.anchor)"))
