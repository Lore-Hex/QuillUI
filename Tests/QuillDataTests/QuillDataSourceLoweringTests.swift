...
struct QuillDataSourceLoweringTests {
    ...
    func visualSmokeExposesOptInMacReferenceLandmarks() throws {
        ...
        #expect(functionalScript.contains("${QUILLUI_FUNCTIONAL_TEXT_INPUT_MODE:-auto}"))
        #expect(functionalScript.contains("expected auto, paste, or type"))
        #expect(functionalScript.contains("auto|paste)"))
...
"""))
        ...
        #expect(functionalScript.contains("return message_text in content"))
