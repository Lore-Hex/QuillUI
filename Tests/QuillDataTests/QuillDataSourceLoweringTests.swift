...
"""))
    ...
    func swiftOpenUIGTKPatchKeepsEnchantedFixesGeneric() throws {
        ...
        #expect(navigationContract.contains("gtk_widget_set_halign(trailingCluster, GTK_ALIGN_END)"))
        #expect(navigationContract.contains("gtk_widget_set_hexpand(spacer, 1)"))
