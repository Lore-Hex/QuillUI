...
struct QuillDataSourceLoweringTests {
    ...
    func visualSmokeExposesOptInMacReferenceLandmarks() throws {
        ...
        #expect(chatViewTemplate.contains("copyChat: copyVisibleChat"))
        #expect(chatViewTemplate.contains("private func copyVisibleChat(_ json: Bool)"))
        #expect(chatViewTemplate.contains("guard !messages.isEmpty else"))
        #expect(chatViewTemplate.contains("ChatCopyMessage(role: $0.role, content: $0.content)"))
        #expect(chatViewTemplate.contains("Clipboard.shared.setString(jsonString)"))
        #expect(chatViewTemplate.contains("Clipboard.shared.setString(body)"))
