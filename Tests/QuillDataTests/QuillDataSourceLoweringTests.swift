...
struct QuillDataSourceLoweringTests {
    ...
    func visualSmokeExposesOptInMacReferenceLandmarks() throws {
        ...
        #expect(verifier.contains("model_x0 = panel_segment.start + 100"))
        #expect(verifier.contains("model_y0 = panel_y + 280"))
        ...
        #expect(interactionScript.contains("reset_x=\"${QUILLUI_BACKEND_COMPLETIONS_RESET_CLICK_X:-${QUILLUI_BACKEND_NEW_CHAT_CLICK_X:-$((window_x + window_width - 38))}}\""))
        #expect(interactionScript.contains("reset_y=\"${QUILLUI_BACKEND_COMPLETIONS_RESET_CLICK_Y:-${QUILLUI_BACKEND_NEW_CHAT_CLICK_Y:-$((window_y + 57))}}\""))
        ...
        #expect(interactionScript.contains("QUILLUI_BACKEND_COMPLETIONS_RESET_SLEEP"))
        #expect(interactionScript.contains("click_x=\"${QUILLUI_BACKEND_CLICK_X:-$((window_x + 90))}\""))
        #expect(interactionScript.contains("click_y=\"${QUILLUI_BACKEND_CLICK_Y:-$((window_y + 1244))}\""))
