...
struct QuillDataSourceLoweringTests {
    ...
    func visualSmokeExposesOptInMacReferenceLandmarks() throws {
        ...
        #expect(functionalScript.contains("attachment_y=\"${QUILLUI_FUNCTIONAL_ATTACHMENT_Y:-$(quill_chat_functional_composer_click_y)}\""))
        ...
        #expect(functionalScript.contains("send_y=\"${QUILLUI_FUNCTIONAL_SEND_Y:-$(quill_chat_functional_composer_click_y)}\""))
        #expect(functionalScript.contains("click_x=\"$(quill_chat_functional_composer_click_x)\""))
        #expect(functionalScript.contains("click_y=\"$(quill_chat_functional_composer_click_y)\""))
