...
struct QuillDataSourceLoweringTests {
    ...
    func visualSmokeExposesOptInMacReferenceLandmarks() throws {
        ...
        #expect(interactionScript.contains("QUILLUI_BACKEND_COMPLETIONS_RESET_CANCEL_SETTLE_SLEEP:-0.2"))
        ...
        #expect(interactionScript.contains("reset_cancel_y=\"${QUILLUI_BACKEND_COMPLETIONS_RESET_CANCEL_CLICK_Y:-${QUILLUI_BACKEND_SETTINGS_CANCEL_CLICK_Y:-$((window_y + 412))}}\""))
        #expect(interactionScript.contains("DISPLAY=\"$DISPLAY_ID\" xdotool key --clearmodifiers Escape"))
        ...
        #expect(interactionScript.contains("ensure_quill_chat_completions_panel_open() {\n  local attempt"))
        #expect(interactionScript.contains("the first Completions click only clears the\n  # stale toggle state"))
        #expect(interactionScript.contains("for attempt in 1 2 3; do\n    if [[ \"$attempt\" == \"1\" ]]; then\n      open_quill_chat_completions_panel 1"))
