...
struct QuillDataSourceLoweringTests {
    ...
    func visualSmokeExposesOptInMacReferenceLandmarks() throws {
        ...
        #expect(parityWorkflow.contains("alert-settings-panel"))
        ...
        #expect(parityWorkflow.contains("settings-delete-confirmed"))
        #expect(parityWorkflow.contains("completions-panel"))
        #expect(parityWorkflow.contains("completions-new-sheet"))
        #expect(parityWorkflow.contains("completions-save"))
        #expect(parityWorkflow.contains("completions-edit-save"))
        #expect(parityWorkflow.contains("completions-delete"))
        #expect(parityWorkflow.contains("new-chat"))
        #expect(parityWorkflow.contains("toolbar-model-selected"))
        #expect(parityWorkflow.contains("prompt-send"))
        #expect(parityWorkflow.contains("copy-chat"))
        #expect(parityWorkflow.contains("copy-chat-json"))
        ...
        #expect(chatViewTemplate.contains("modelActions: modelMenuActions"))
        #expect(chatViewTemplate.contains("optionsActions: optionsMenuActions"))
        ...
        #expect(chatViewTemplate.contains("version: { $0.prettyVersion }"))
        #expect(chatViewTemplate.contains("onSelect: onSelectModel"))
        ...
        #expect(emptyConversationTemplate.contains("from: SamplePrompts.samples"))
        ...
        #expect(sidebarTemplate.contains("showSettings: $showSettings"))
        #expect(sidebarTemplate.contains("showCompletions: $showCompletions"))
        #expect(sidebarTemplate.contains("showShortcuts: $showKeyboardShortcuts"))
        ...
        #expect(messageListTemplate.contains("selectText: { messageSelected = message }"))
        #expect(messageListTemplate.contains("readAloud: { onReadAloud(message.content) }"))
