...
struct QuillDataSourceLoweringTests {
    ...
    func visualSmokeExposesOptInMacReferenceLandmarks() throws {
        ...
        #expect(parityWorkflow.contains("release_launcher=\"$PWD/.build/releases/quill-chat-linux-gtk/run\""))
        #expect(parityWorkflow.contains("QUILLUI_BACKEND_APP_EXECUTABLE=\"$release_launcher\""))
