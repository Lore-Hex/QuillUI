...
struct QuillDataSourceLoweringTests {
    ...
    func visualSmokeExposesOptInMacReferenceLandmarks() throws {
        ...
        #expect(interactionScript.contains("quill-chat-selection-probe-${INTERACTION_MODE}-${INTERACTION_ATTEMPT}.png"))
        ...
        #expect(interactionScript.contains("auto-scroll did not verify long transcript bottom; applying explicit scroll fallback"))
        #expect(interactionScript.contains("scroll_quill_chat_transcript_to_bottom"))
