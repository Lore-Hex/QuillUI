...
struct QuillDataSourceLoweringTests {
    ...
    func profileBudgetAuditEnforcesSmallShellGlue() throws {
        ...
        #expect(workflow.contains("scripts/audit-profile-budget.sh --max-shell-lines 50 --max-template-lines 180"))
    ...
    func visualSmokeExposesOptInMacReferenceLandmarks() throws {
        ...
        #expect(chatViewTemplate.contains("selectedContent: { editMessage in"))
