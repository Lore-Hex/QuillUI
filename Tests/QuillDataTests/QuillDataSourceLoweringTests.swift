...
struct QuillDataSourceLoweringTests {
    ...
    func visualSmokeExposesOptInMacReferenceLandmarks() throws {
        ...
        #expect(interactionScript.contains("points: list[tuple[int, int]] = []"))
        #expect(interactionScript.contains("x0 = int(width * 0.64)"))
        #expect(interactionScript.contains("y0 = int(height * 0.32)"))
