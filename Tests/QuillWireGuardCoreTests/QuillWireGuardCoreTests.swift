...
struct QuillWireGuardCoreTests {
    ...
    func wireGuardAppEntryPointsShareUISceneHelper() throws {
        ...
        #expect(nativeShimSource.contains("\"quill-wireguard-qt\""))
        ...
        #expect(nativeShimSource.contains("void reportStartupImportError(const QString &message)"))
        #expect(nativeShimSource.contains("std::fprintf(stderr, \"quill-wireguard-qt: startup import failed: %s\\n\""))
        ...
        #expect(nativeShimSource.contains("reportStartupImportError(fileError)"))
        #expect(nativeShimSource.contains("reportStartupImportError(importError)"))
