...
"""))
    ...
    func linuxBackendFacadesScriptsAndWorkflowsStayBackendNeutral() throws {
        ...
        #expect(solderScopeSmoke.contains("DISPLAY=\"$DISPLAY_ID\" xdotool key --window \"$window_id\" i"))
        #expect(solderScopeSmoke.contains("DISPLAY=\"$DISPLAY_ID\" xdotool key --window \"$window_id\" h"))
        #expect(solderScopeSmoke.contains("DISPLAY=\"$DISPLAY_ID\" xdotool key --window \"$window_id\" v"))
