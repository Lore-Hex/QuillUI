...
struct SourceHygieneTests {
    ...
    func signalUIKitRendererBindsLiveViewMutationsOntoGtkWidgets() throws {
        let renderer = try packageSource("Sources/SignalUIRender/Renderer.swift")
        let containers = try packageSource("Sources/SignalUIRender/Mappers/ContainerMappers.swift")
        let tables = try packageSource("Sources/SignalUIRender/Mappers/TableMappers.swift")
        let labels = try packageSource("Sources/SignalUIRender/Mappers/LabelImageMappers.swift")
        let textViewBridge = try packageSource("Sources/SignalUIRender/Mappers/TextViewEntryBridge.swift")
