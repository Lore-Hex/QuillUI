...
struct SourceHygieneTests {
    ...
    func enchantedQtHostFollowsMacOSVisualAndInteractionContract() throws {
        ...
        #expect(enchantedQtHost.contains("applyActionButtonIconSize(attachButton, style)"))
        #expect(enchantedQtHost.contains("applyActionButtonIconSize(sendButton, style)"))
