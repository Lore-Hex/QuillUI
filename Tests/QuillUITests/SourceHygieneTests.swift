...
"""))
    ...
    func gtkQuillPaintHooksCoverButtonAndTextInputChrome() throws {
        ...
        #expect(renderer.contains("gtk_text_view_set_top_margin(textViewPtr, 6)"))
        #expect(renderer.contains("gtk_text_view_set_bottom_margin(textViewPtr, 6)"))
        #expect(renderer.contains("gtk_text_view_set_left_margin(textViewPtr, 8)"))
        #expect(renderer.contains("gtk_text_view_set_right_margin(textViewPtr, 8)"))
