...
struct SourceHygieneTests {
    ...
    func enchantedQtHostFollowsMacOSVisualAndInteractionContract() throws {
        ...
        #expect(enchantedModel.contains("private func takeComposerDraft() -> (prompt: String, attachments: [PendingImageAttachment])?"))
        ...
        #expect(enchantedModel.contains("await send(draft.prompt, attachments: draft.attachments)"))
        #expect(enchantedModel.contains("startSend(draft.prompt, attachments: draft.attachments)"))
