...
"""))
    ...
    func enchantedComposerRewriteExpandsBeforeDrawingBorder() throws {
        ...
        #expect(profileLowering.contains("selectedImage: \\$selectedImage"))
    ...
    func linuxBackendFacadesScriptsAndWorkflowsStayBackendNeutral() throws {
        ...
        #expect(backendScript.contains("reset_cancel_x=\"${QUILLUI_BACKEND_COMPLETIONS_RESET_CANCEL_CLICK_X:-${QUILLUI_BACKEND_SETTINGS_CANCEL_CLICK_X:-$((window_x + window_width / 2 - 420))}}\""))
        #expect(backendScript.contains("reset_cancel_y=\"${QUILLUI_BACKEND_COMPLETIONS_RESET_CANCEL_CLICK_Y:-${QUILLUI_BACKEND_SETTINGS_CANCEL_CLICK_Y:-$((window_y + 410))}}\""))
        ...
        #expect(solderScopeSmoke.contains("QUILLUI_SOLDERSCOPE_RECORDING_STOP_FALLBACK_DRIVER"))
        #expect(solderScopeSmoke.contains("QUILLUI_SOLDERSCOPE_RECORDING_STOP_FALLBACK_TICK:-8"))
        #expect(solderScopeSmoke.contains("QUILLUI_SOLDERSCOPE_RECORDING_STOP_FALLBACK_RETRY_INTERVAL_TICKS:-12"))
        ...
        #expect(solderScopeWorkflow.contains("SolderScope GTK snapshot and freeze smoke"))
