...
struct SourceHygieneTests {
    ...
    func enchantedQtHostFollowsMacOSVisualAndInteractionContract() throws {
        ...
        #expect(enchantedUpstreamSlice.contains("QuillSidebarNavigationAction(title: \"Completions\", systemImage: EnchantedIcon.completions)"))
        #expect(enchantedUpstreamSlice.contains("QuillSidebarNavigationAction(title: \"Shortcuts\", systemImage: EnchantedIcon.shortcuts)"))
        #expect(enchantedUpstreamSlice.contains("QuillSidebarNavigationAction(title: \"Settings\", systemImage: EnchantedIcon.settings)"))
