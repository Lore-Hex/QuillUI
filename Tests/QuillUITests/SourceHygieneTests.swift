...
struct SourceHygieneTests {
    ...
    func enchantedQtHostFollowsMacOSVisualAndInteractionContract() throws {
        ...
        #expect(enchantedUpstreamSlice.contains("QuillSidebarNavigationAction(title: \"Completions\", systemImage: \"character.cursor.ibeam\")"))
        #expect(enchantedUpstreamSlice.contains("QuillSidebarNavigationAction(title: \"Shortcuts\", systemImage: \"keyboard\")"))
        #expect(enchantedUpstreamSlice.contains("QuillSidebarNavigationAction(title: \"Settings\", systemImage: \"gearshape.fill\")"))
        ...
        #expect(enchantedShared.contains("public static let completions = \"character.cursor.ibeam\""))
        #expect(enchantedShared.contains("public static let shortcuts = \"keyboard\""))
