...
struct SourceHygieneTests {
    ...
    func linuxInteractionSmokeTargetsShareOneViewSurface() throws {
        ...
        #expect(manifest.contains("let quillQtInteractionSmokeDependencies: [Target.Dependency] = quillUILinuxBuildBackend == .qt"))
        #expect(manifest.contains("? [\"CQuillQt6WidgetsShim\"]"))
        #expect(manifest.contains(": [\"QuillUIQt\", \"QuillInteractionSmokeSupport\"]"))
        ...
        #expect(backendScript.contains("quill-wireguard|quill-wireguard-qt) INTERACTION_MODE=\"tunnel-name-edit\""))
