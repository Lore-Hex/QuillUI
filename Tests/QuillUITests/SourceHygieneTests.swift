...
"""))
    ...
    func gtkPatcherPreservesFixedFrameAndListViewportSizingContracts() throws {
        ...
        #expect(patcher.contains("g_object_set_data(contentObject, gtkRootPresentationOverlayKey, gpointer(overlay))"))
        #expect(patcher.contains("return gtkRootPresentationOverlayFallback"))
