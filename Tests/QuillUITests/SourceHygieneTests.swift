...
"""))
    ...
    func quillDesktopSplitLayoutMirrorsMacReferenceTitlebarChrome() throws {
        ...
        #expect(messageHoverActions.contains("private let quillGTKMessageHoverRowClass = \"quill-message-hover-row\""))
        #expect(messageHoverActions.contains("private let quillGTKMessageHoverActionsClass = \"quill-message-hover-actions\""))
        #expect(messageHoverActions.contains("private let quillGTKMessageHoverActionsVisibleClass = \"quill-message-hover-actions-visible\""))
        #expect(messageHoverActions.contains("quillGTKInstallMessageHoverActionCSS(on: container, actionWidget: actionWidget)"))
        #expect(messageHoverActions.contains("gtk_css_provider_load_from_string(provider, css)"))
        #expect(messageHoverActions.contains(".\\(quillGTKMessageHoverRowClass):hover .\\(quillGTKMessageHoverActionsClass)"))
        #expect(messageHoverActions.contains("gtk_widget_add_css_class(rowWidget, quillGTKMessageHoverRowClass)"))
        #expect(messageHoverActions.contains("gtk_widget_add_css_class(actionWidget, quillGTKMessageHoverActionsClass)"))
