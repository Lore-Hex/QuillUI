...
"""))
    ...
    func linuxBackendFacadesScriptsAndWorkflowsStayBackendNeutral() throws {
        ...
        #expect(solderScopeSmoke.contains("using last verified visible frame for final verifier"))
    ...
    func quillDesktopSplitLayoutMirrorsMacReferenceTitlebarChrome() throws {
        ...
        #expect(messageHoverActions.contains("gtk_widget_add_css_class(actionWidget, quillGTKMessageHoverActionsVisibleClass)"))
        #expect(messageHoverActions.contains("gtk_widget_remove_css_class(actionWidget, quillGTKMessageHoverActionsVisibleClass)"))
