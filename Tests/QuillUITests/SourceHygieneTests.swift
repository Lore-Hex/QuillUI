...
struct SourceHygieneTests {
    ...
    func linuxInteractionSmokeTargetsShareOneViewSurface() throws {
        ...
        #expect(backendScript.contains("quillui_append_quill_chat_reference_environment_if_needed"))
        ...
        #expect(backendVisualScript.contains("quillui_append_quill_chat_reference_environment_if_needed"))
        #expect(backendVisualScript.contains("quillui_backend_visual_verify_product \"$PRODUCT\" VERIFY_PRODUCT"))
        #expect(backendVisualScript.contains("quillui_append_backend_layout_debug_environment app_environment \"${QUILLUI_BACKEND_LAYOUT_DEBUG:-}\""))
