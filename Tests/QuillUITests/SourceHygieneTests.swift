...
"""))
    ...
    func upstreamIceCubesVisualSmokeIsFirstClassLinuxArtifact() throws {
        ...
        #expect(script.contains("AUTH_COMPOSER_SEND_X=\"${QUILLUI_ICECUBES_VISUAL_AUTH_COMPOSER_SEND_X:-755}\""))
        #expect(script.contains("AUTH_COMPOSER_SEND_Y=\"${QUILLUI_ICECUBES_VISUAL_AUTH_COMPOSER_SEND_Y:-111}\""))
        #expect(script.contains("AUTH_COMPOSER_TYPE_Y=\"${QUILLUI_ICECUBES_VISUAL_AUTH_COMPOSER_TYPE_Y:-285}\""))
