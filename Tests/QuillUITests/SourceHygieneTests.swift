...
"""))
    ...
    func upstreamIceCubesVisualSmokeIsFirstClassLinuxArtifact() throws {
        ...
        #expect(script.contains("AUTH_STATUS_DETAIL_BOOKMARK_POINTS=\"${QUILLUI_ICECUBES_VISUAL_AUTH_STATUS_DETAIL_BOOKMARK_POINTS:-$AUTH_STATUS_DETAIL_SECONDARY_BOOKMARK_X,432 568,432"))
        ...
        #expect(script.contains("AUTH_STATUS_DETAIL_SECONDARY_BOOKMARK_POST_LOG=\"POST https://mastodon.social/api/v1/statuses/1001/bookmark\""))
        ...
        #expect(!script.contains("primary_count + secondary_count + paginated_count"))
