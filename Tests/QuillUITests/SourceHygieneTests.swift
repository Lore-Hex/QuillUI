...
"""))
    ...
    func upstreamIceCubesVisualSmokeIsFirstClassLinuxArtifact() throws {
        ...
        #expect(gtkDescriptorTree.contains("children: [gtkWithSuppressedDescriptorLifecyclePayloads {"))
        ...
        #expect(patcher.contains("SwiftOpenUI stateful descriptor lifecycle ownership shape was not recognized"))
        #expect(patcher.contains("SwiftOpenUI GTKViewHost stable namespace render shape was not recognized"))
