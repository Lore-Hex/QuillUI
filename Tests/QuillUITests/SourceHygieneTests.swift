...
struct SourceHygieneTests {
    ...
    func enchantedQtHostFollowsMacOSVisualAndInteractionContract() throws {
        ...
        #expect(enchantedQtHost.contains("const QString updatedModelStatus = modelStatusText(model, chooseLocalModelStatus, usingModelStatusPrefix, usingModelStatusSeparator);\n        modelStatus->setText(updatedModelStatus);\n        updateModelStatusAccessibility(updatedModelStatus);\n        discardUnsupportedAttachmentState();\n        updateComposerControlState();"))
