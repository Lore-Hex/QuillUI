...
struct SourceHygieneTests {
    ...
    func enchantedQtHostFollowsMacOSVisualAndInteractionContract() throws {
        ...
        #expect(enchantedQtHost.contains("row->setSpacing(styleInt(style, \"messageBubbleRowSpacing\"))"))
        #expect(enchantedQtHost.contains("const int messageBubblePadding = styleInt(style, \"messageBubblePadding\")"))
        #expect(enchantedQtHost.contains("layout->setContentsMargins(\n        messageBubblePadding,\n        messageBubblePadding,\n        messageBubblePadding,\n        messageBubblePadding\n    )"))
        #expect(enchantedQtHost.contains("layout->setSpacing(styleInt(style, \"messageBubbleSpacing\"))"))
        ...
        #expect(enchantedQtHost.contains("layout->setSpacing(styleInt(style, \"markdownBlockSpacing\"))"))
