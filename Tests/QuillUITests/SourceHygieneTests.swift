...
struct SourceHygieneTests {
    ...
    func enchantedQtHostFollowsMacOSVisualAndInteractionContract() throws {
        ...
        #expect(enchantedMacRoot.contains("Image(systemName: EnchantedIcon.newConversation)"))
        ...
        #expect(enchantedMacRoot.contains("Image(systemName: EnchantedIcon.attach)"))
        #expect(enchantedMacRoot.contains("Button(EnchantedCopy.clearAttachmentsTitle)"))
        #expect(enchantedMacRoot.contains("Image(systemName: model.isLoading ? EnchantedIcon.stop : EnchantedIcon.send)"))
        ...
        #expect(enchantedQtHost.contains("QLabel#dropTargetLabel { color: %2; font-size: %5; }"))
        #expect(enchantedQtHost.contains("QFrame *dropHint = QuillQtWidgets::frame(QStringLiteral(\"dropTargetHint\"))"))
        ...
        #expect(enchantedMacRoot.contains("Image(systemName: EnchantedIcon.dropTarget)"))
        ...
        #expect(enchantedMacRoot.contains("Image(systemName: EnchantedIcon.removeAttachment)"))
        ...
        #expect(enchantedQtHost.contains("const bool hasSelectedModel = modelPicker != nullptr && !modelPicker->currentText().trimmed().isEmpty()"))
        #expect(enchantedQtHost.contains("const bool showUnavailableModelButton = !hasSelectedModel"))
        #expect(enchantedQtHost.contains("attachmentInputRow->setVisible(imageAttachmentsAvailable || showUnavailableModelButton)"))
        #expect(enchantedQtHost.contains("attachmentPath->setVisible(imageAttachmentsAvailable)"))
        #expect(enchantedQtHost.contains("unavailableModelButton->setVisible(showUnavailableModelButton)"))
        ...
        #expect(enchantedQtHost.contains("dropTarget->setVisible(imageAttachmentsAvailable || hasPendingAttachments || showUnavailableModelButton)"))
        ...
        #expect(enchantedQtHost.contains("auto discardUnsupportedAttachmentState = [&]()"))
