...
struct SourceHygieneTests {
    ...
    func enchantedQtHostFollowsMacOSVisualAndInteractionContract() throws {
        ...
        #expect(enchantedQtHost.contains("app.setApplicationName(stringValue(payload, \"windowTitle\"))"))
        #expect(enchantedQtHost.contains("window.setWindowTitle(stringValue(payload, \"windowTitle\"))"))
        #expect(enchantedQtHost.contains("stringValue(payload, \"sidebarTitle\")"))
        #expect(enchantedQtHost.contains("stringValue(payload, \"sidebarSubtitle\")"))
        #expect(enchantedQtHost.contains("stringValue(payload, \"endpointLabel\")"))
        #expect(enchantedQtHost.contains("const QString modelLabel = stringValue(payload, \"modelLabel\")"))
        #expect(enchantedQtHost.contains("stringValue(payload, \"conversationsTitle\")"))
        #expect(enchantedQtHost.contains("QPushButton *deleteButton = new QPushButton(stringValue(payload, \"deleteChatTitle\"))"))
        #expect(enchantedQtHost.contains("QPushButton *completionsButton = new QPushButton(stringValue(payload, \"completionsTitle\"))"))
        #expect(enchantedQtHost.contains("QPushButton *shortcutsButton = new QPushButton(stringValue(payload, \"shortcutsTitle\"))"))
        #expect(enchantedQtHost.contains("QPushButton *settingsButton = new QPushButton(stringValue(payload, \"settingsTitle\"))"))
        #expect(enchantedQtHost.contains("QPushButton *refreshButton = new QPushButton(stringValue(payload, \"refreshModelsTitle\"))"))
        #expect(enchantedQtHost.contains("stringValue(payload, \"completionsPanelSubtitle\")"))
        #expect(enchantedQtHost.contains("stringValue(payload, \"shortcutsPanelSubtitle\")"))
        #expect(enchantedQtHost.contains("stringValue(payload, \"settingsPanelSubtitle\")"))
        #expect(enchantedQtHost.contains("stringValue(payload, \"completionsStatus\")"))
        #expect(enchantedQtHost.contains("stringValue(payload, \"shortcutsStatus\")"))
        #expect(enchantedQtHost.contains("stringValue(payload, \"settingsStatus\")"))
        ...
        #expect(enchantedQtHost.contains("modelStatusText(stringValue(payload, \"selectedModel\"), chooseLocalModelStatus, usingModelStatusPrefix)"))
        ...
        #expect(enchantedQtHost.contains("stringValue(payload, \"noModelsTitle\")"))
        ...
        #expect(enchantedQtHost.contains("stringValue(payload, \"clearAllTitle\")"))
        ...
        #expect(enchantedQtHost.contains("stringValue(payload, \"emptyHistoryTitle\")"))
        #expect(enchantedQtHost.contains("stringValue(payload, \"emptyHistorySubtitle\")"))
        ...
        #expect(!enchantedQtHost.contains("QIcon shortcutsButtonIcon()"))
        #expect(!enchantedQtHost.contains("QIcon settingsButtonIcon()"))
        #expect(enchantedQtHost.contains("const QString newConversationButtonTitle = stringValue(payload, \"newConversationButtonTitle\")"))
        ...
        #expect(enchantedQtHost.contains("stringValue(payload, \"attachmentPlaceholder\")"))
        #expect(!enchantedQtHost.contains("QStringLiteral(\"Image path or drop files here\")"))
        #expect(enchantedQtHost.contains("stringValue(payload, \"attachTitle\")"))
        ...
        #expect(enchantedQtHost.contains("stringValue(payload, \"clearAttachmentsTitle\")"))
        #expect(!enchantedQtHost.contains("stringValue(payload, \"clearAttachmentsTitle\", QStringLiteral(\"Clear\"))"))
        #expect(enchantedQtHost.contains("stringValue(payload, \"attachmentsTitle\")"))
        #expect(!enchantedQtHost.contains("stringValue(payload, \"attachmentsTitle\", QStringLiteral(\"Attachments\"))"))
        #expect(enchantedQtHost.contains("stringValue(payload, \"attachmentDefaultPrompt\")"))
        #expect(!enchantedQtHost.contains("QStringLiteral(\"Describe this image.\")"))
        #expect(enchantedQtHost.contains("stringValue(payload, \"attachmentDefaultPromptPlural\")"))
        #expect(!enchantedQtHost.contains("QStringLiteral(\"Describe these images.\")"))
        #expect(enchantedQtHost.contains("stringValue(payload, \"attachmentSummaryTitle\")"))
        ...
        #expect(enchantedQtHost.contains("stringValue(payload, \"attachmentsClearedStatus\")"))
        #expect(!enchantedQtHost.contains("QStringLiteral(\"Attachments cleared\")"))
        #expect(enchantedQtHost.contains("stringValue(payload, \"attachmentRemovedEmptyStatus\")"))
        ...
        #expect(enchantedQtHost.contains("stringValue(payload, \"dropTargetTitle\")"))
        ...
        #expect(enchantedQtHost.contains("stringValue(payload, \"sendTitle\")"))
        #expect(!enchantedQtHost.contains("QStringLiteral(\"Send\")"))
        #expect(enchantedQtHost.contains("stringValue(payload, \"stopTitle\")"))
        #expect(!enchantedQtHost.contains("QStringLiteral(\"Stop\")"))
        #expect(enchantedQtHost.contains("stringValue(payload, \"stoppingStatus\")"))
        #expect(!enchantedQtHost.contains("QStringLiteral(\"Stopping...\")"))
        #expect(enchantedQtHost.contains("stringValue(payload, \"removeAttachmentTooltip\")"))
        #expect(!enchantedQtHost.contains("QStringLiteral(\"Remove attachment\")"))
        #expect(enchantedQtHost.contains("stringValue(payload, \"imageReadyStatusSingular\")"))
        #expect(!enchantedQtHost.contains("QStringLiteral(\"1 image ready to send\")"))
        #expect(enchantedQtHost.contains("stringValue(payload, \"imageReadyStatusPluralUnit\")"))
        ...
        #expect(enchantedQtHost.contains("stringValue(payload, \"composerPlaceholder\")"))
        #expect(!enchantedQtHost.contains("QStringLiteral(\"Ask a local model...\")"))
        #expect(enchantedQtHost.contains("stringValue(payload, \"emptyStateTitle\")"))
        #expect(!enchantedQtHost.contains("QStringLiteral(\"Ask your local model\")"))
        #expect(enchantedQtHost.contains("stringValue(payload, \"emptyStateSubtitle\")"))
