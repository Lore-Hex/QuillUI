...
"""))
    ...
    func upstreamIceCubesVisualSmokeIsFirstClassLinuxArtifact() throws {
        ...
        #expect(script.contains("AUTH_STATUS_DETAIL_BOOKMARK_X=\"${QUILLUI_ICECUBES_VISUAL_AUTH_STATUS_DETAIL_BOOKMARK_X:-461}\""))
        #expect(script.contains("AUTH_STATUS_DETAIL_BOOKMARK_POINTS=\"${QUILLUI_ICECUBES_VISUAL_AUTH_STATUS_DETAIL_BOOKMARK_POINTS:-$AUTH_STATUS_DETAIL_BOOKMARK_X,$AUTH_STATUS_DETAIL_BOOKMARK_Y 474,$AUTH_STATUS_DETAIL_BOOKMARK_Y"))
