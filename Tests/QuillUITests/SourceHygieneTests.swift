...
struct SourceHygieneTests {
    ...
    func enchantedQtHostFollowsMacOSVisualAndInteractionContract() throws {
        ...
        #expect(enchantedMacMarkdown.contains("taskListItemText(in: item)"))
        #expect(enchantedMacMarkdown.contains("private static func taskListItemText(in text: String) -> String"))
        ...
        #expect(enchantedQtHost.contains("QString markdownTaskListItemText(const QString &text)"))
        ...
        #expect(enchantedQtHost.contains("const QString parsedText = cleanMarkdownInline(markdownTaskListItemText(line.mid(2).trimmed()));\n    if (parsedText.isEmpty())"))
        #expect(enchantedQtHost.contains("if (textStart >= line.size() || !line.at(textStart).isSpace())"))
        #expect(enchantedQtHost.contains("const QString parsedText = cleanMarkdownInline(markdownTaskListItemText(line.mid(textStart + 1).trimmed()));\n    if (parsedText.isEmpty())"))
