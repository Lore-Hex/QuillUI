...
"""))
    ...
    func vendoredGTKRendererPreservesSwiftUIScrollRowWidthContract() throws {
        ...
        #expect(renderer.contains("gtk_widget_set_valign(child, childWantsVerticalFill ? GTK_ALIGN_FILL : GTK_ALIGN_START)"))
        ...
        #expect(renderer.contains("fillHeight: axes.contains(.horizontal) && !axes.contains(.vertical) && childWantsVerticalFill"))
        ...
        #expect(patcher.contains("fillHeight: axes.contains(.horizontal) && !axes.contains(.vertical) && childWantsVerticalFill"))
    ...
    func vendoredGTKRendererAppliesSwiftUIFormRowMetadata() throws {
        ...
        #expect(renderer.contains("gtk_widget_set_vexpand(listBox, 0)"))
        #expect(renderer.contains("gtk_widget_set_valign(listBox, GTK_ALIGN_START)"))
