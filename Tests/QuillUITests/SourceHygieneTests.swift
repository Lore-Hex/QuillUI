...
"""))
    ...
    func upstreamIceCubesVisualSmokeIsFirstClassLinuxArtifact() throws {
        ...
        #expect(script.contains("AUTH_SETTINGS_DISPLAY_FONT_SCALE_END_X=\"${QUILLUI_ICECUBES_VISUAL_AUTH_SETTINGS_DISPLAY_FONT_SCALE_END_X:-720}\""))
        #expect(script.contains("AUTH_SETTINGS_DISPLAY_FONT_SCALE_Y=\"${QUILLUI_ICECUBES_VISUAL_AUTH_SETTINGS_DISPLAY_FONT_SCALE_Y:-582}\""))
        ...
        #expect(script.contains("AUTH_STATUS_DETAIL_BOOST_Y=\"${QUILLUI_ICECUBES_VISUAL_AUTH_STATUS_DETAIL_BOOST_Y:-436}\""))
        #expect(script.contains("AUTH_STATUS_DETAIL_BOOST_POINTS=\"${QUILLUI_ICECUBES_VISUAL_AUTH_STATUS_DETAIL_BOOST_POINTS:-$AUTH_STATUS_DETAIL_BOOST_X,$AUTH_STATUS_DETAIL_BOOST_Y 360,$AUTH_STATUS_DETAIL_BOOST_Y"))
