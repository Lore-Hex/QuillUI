...
struct SourceHygieneTests {
    ...
    func enchantedQtHostFollowsMacOSVisualAndInteractionContract() throws {
        ...
        #expect(enchantedQtHost.contains("completionsButton->setIcon(utilityButtonIcon(icons, \"completions\"))"))
        #expect(enchantedQtHost.contains("shortcutsButton->setIcon(utilityButtonIcon(icons, \"shortcuts\"))"))
        #expect(enchantedQtHost.contains("settingsButton->setIcon(utilityButtonIcon(icons, \"settings\"))"))
        ...
        #expect(enchantedQtHost.contains("QPushButton *completionsButton = new QPushButton(payloadString(payload, \"completionsTitle\"))"))
        #expect(enchantedQtHost.contains("QPushButton *shortcutsButton = new QPushButton(payloadString(payload, \"shortcutsTitle\"))"))
        #expect(enchantedQtHost.contains("QPushButton *settingsButton = new QPushButton(payloadString(payload, \"settingsTitle\"))"))
        ...
        #expect(enchantedQtHost.contains("newConversationButton->setIcon(newConversationButtonIcon(icons))"))
        #expect(enchantedQtHost.contains("applyButtonIconSize(newConversationButton, style)"))
        ...
        #expect(enchantedQtHost.contains("applyButtonIconSize(sendButton, style)"))
        ...
        #expect(enchantedQtHost.contains("updateSendButtonPresentation(sendButton, icons, isLoading, sendTitle, stopTitle)"))
        #expect(enchantedQtHost.contains("button->setProperty(\"loading\", isLoading)"))
        #expect(enchantedQtHost.contains("button->setText(isLoading ? stopTitle : sendTitle)"))
