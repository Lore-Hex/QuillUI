...
struct SourceHygieneTests {
    ...
    func enchantedQtHostFollowsMacOSVisualAndInteractionContract() throws {
        ...
        #expect(enchantedUpstreamSlice.contains("QuillChatEmptyState(brandTitle: EnchantedCopy.appTitle"))
        ...
        #expect(enchantedQtHost.contains("const int messageBubblePadding = styleInt(style, \"messageBubblePadding\")"))
        ...
        #expect(enchantedQtHost.contains("promptList->setSpacing(styleInt(style, \"promptListSpacing\"))"))
        #expect(enchantedQtHost.contains("const int promptButtonMinHeight = styleInt(style, \"promptButtonMinHeight\")"))
        #expect(enchantedQtHost.contains("button->setMinimumHeight(promptButtonMinHeight)"))
        #expect(enchantedQtHost.contains("const int promptButtonWidth = styleInt(style, \"promptButtonWidth\")"))
        #expect(enchantedQtHost.contains("button->setFixedWidth(promptButtonWidth)"))
    ...
    func linuxBackendFacadesScriptsAndWorkflowsStayBackendNeutral() throws {
        ...
        let enchantedParityWorkflow = try packageSource(".github/workflows/enchanted-parity.yml")
        ...
        #expect(backendProducts.contains("quillui_is_enchanted_mac_reference_product()"))
        #expect(backendProducts.contains("quillui_backend_mac_reference_verify_product()"))
        ...
        #expect(backendVisualScript.contains("quillui_is_enchanted_mac_reference_product \"$PRODUCT\""))
        ...
        #expect(backendVisualScript.contains("quillui_find_enchanted_reference_window \"$DISPLAY_ID\" \"$PRODUCT\""))
        ...
        #expect(smokeLib.contains("verify_product=\"$(quillui_backend_mac_reference_verify_product \"$product\")\""))
        ...
        #expect(screenshotVerifier.contains("ENCHANTED_MAC_REFERENCE_PRODUCTS"))
        #expect(screenshotVerifier.contains("Tests\" / \"Fixtures\" / \"Enchanted\" / \"macos-reference.png"))
        #expect(screenshotVerifier.contains("Enchanted Mac-reference pixel match ratio="))
        #expect(screenshotVerifier.contains("QUILLUI_BACKEND_MAC_REFERENCE_MIN_RATIO"))
        #expect(enchantedParityWorkflow.contains("QUILLUI_BACKEND_MAC_REFERENCE: \"1\""))
        #expect(enchantedParityWorkflow.contains("QUILLUI_BACKEND_MAC_REFERENCE_MIN_RATIO: \"0.95\""))
        #expect(enchantedParityWorkflow.contains("scripts/linux-backend-visual-check.sh .qa/quill-enchanted-mac-reference-gtk.png quill-enchanted-linux gtk"))
    ...
    func quillConversationHistoryListMirrorsEnchantedRowPreviewAndAccessibility() throws {
        ...
        #expect(historyList.contains("private var rowCornerRadius: CGFloat { 8 }"))
        ...
        #expect(historyList.contains("private var rowBackgroundColor: Color { Color(hex: \"#FFFFFF\") }"))
        #expect(historyList.contains("private var selectedRowBackgroundColor: Color { Color(hex: \"#4285F4\") }"))
        #expect(historyList.contains("private var rowTitleColor: Color { Color(hex: \"#1D1D1F\") }"))
        #expect(historyList.contains("private var selectedRowTitleColor: Color { Color(hex: \"#FFFFFF\") }"))
        #expect(historyList.contains("private var rowPreviewColor: Color { Color(hex: \"#6E6E73\") }"))
        #expect(historyList.contains("private var selectedRowPreviewColor: Color { Color(hex: \"#FFFFFF\") }"))
        #expect(historyList.contains(".foregroundColor(isSelected ? selectedRowTitleColor : rowTitleColor)"))
        #expect(historyList.contains(".foregroundColor(isSelected ? selectedRowPreviewColor : rowPreviewColor)"))
        #expect(historyList.contains(".background(isSelected ? selectedRowBackgroundColor : rowBackgroundColor)"))
