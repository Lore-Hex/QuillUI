...
struct SourceHygieneTests {
    ...
    func linuxInteractionSmokeTargetsShareOneViewSurface() throws {
        ...
        #expect(enchantedQtHost.contains("auto requestHistoryAction ="))
        #expect(enchantedQtHost.contains("requestHistoryAction(QStringLiteral(\"newConversation\"), QString())"))
        #expect(enchantedQtHost.contains("requestHistoryAction(QStringLiteral(\"deleteConversation\"), deletedConversationID)"))
        #expect(enchantedQtHost.contains("requestHistoryAction(QStringLiteral(\"deleteAllConversations\"), QString())"))
