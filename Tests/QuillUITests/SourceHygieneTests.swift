...
"""))
    ...
    func gtkQuillPaintHooksCoverButtonAndTextInputChrome() throws {
        ...
        let gtkPaintHost = try packageSource("Sources/QuillUIGtk/QuillGtkPaintHost.swift")
        ...
        #expect(gtkTextField.contains("quillTextFieldForceFocus(quillGTKWidgetPointer(delegate))"))
        ...
        #expect(gtkPaintHost.contains("gtk_swift_drawing_area_set_draw_func("))
        #expect(gtkPaintHost.contains("CairoPaintContext(cr: cr)"))
        ...
        #expect(gtkTextField.contains("let editorBackgroundColor = PaintCSSColor.rgba(MacColors.controlBackground)"))
        ...
        #expect(gtkToggle.contains("MacCheckboxPaint(value: isActive ? .on : .off)"))
        #expect(gtkToggle.contains("MacSwitchPaint(isOn: isActive)"))
