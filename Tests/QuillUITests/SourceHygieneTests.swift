...
struct SourceHygieneTests {
    ...
    func enchantedQtHostFollowsMacOSVisualAndInteractionContract() throws {
        ...
        #expect(enchantedQtHost.contains("QPushButton *completionsButton = new QPushButton(stringValue(payload, \"completionsTitle\", QStringLiteral(\"Completions\")))"))
        #expect(enchantedQtHost.contains("\"completionsPanelSubtitle\","))
        #expect(enchantedQtHost.contains("QStringLiteral(\"Prompt completions use the shared Enchanted profile.\")"))
        #expect(enchantedQtHost.contains("\"shortcutsPanelSubtitle\","))
        #expect(enchantedQtHost.contains("QStringLiteral(\"Keyboard shortcuts use the shared QuillKit shortcut surface.\")"))
        #expect(enchantedQtHost.contains("\"settingsPanelSubtitle\","))
        ...
        #expect(enchantedQtHost.contains("const QString newConversationButtonTitle = stringValue("))
        #expect(enchantedQtHost.contains("\"newConversationButtonTitle\""))
