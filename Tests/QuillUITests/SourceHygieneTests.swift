...
"""))
    ...
    func genericAndWireGuardQtHostsUseSharedNativeRuntimeContracts() throws {
        ...
        #expect(genericQtHost.contains("persistPromptConversation(promptTitle)"))
        #expect(genericQtHost.contains("populatePromptConversationContent(detailPane.contentLayout, promptTitle, style)"))
