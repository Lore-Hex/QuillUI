...
struct SourceHygieneTests {
    ...
    func enchantedQtHostFollowsMacOSVisualAndInteractionContract() throws {
        ...
        #expect(enchantedQtHost.contains("styleInt(style, \"headerTitleWidth\")"))
        #expect(enchantedQtHost.contains("statusLayout->setSpacing(styleInt(style, \"statusRowSpacing\"))"))
        ...
        #expect(enchantedQtHost.contains("headerLayout->setSpacing(styleInt(style, \"headerSpacing\"))"))
        #expect(enchantedQtHost.contains("titleLayout->setSpacing(styleInt(style, \"headerTitleSpacing\"))"))
        #expect(enchantedQtHost.contains("messageLayout->setSpacing(styleInt(style, \"messageSpacing\"))"))
