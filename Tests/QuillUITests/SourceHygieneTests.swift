...
struct SourceHygieneTests {
    ...
    func enchantedQtRuntimeMirrorsMacOSPayloadContract() throws {
        ...
        #expect(enchantedQtRuntime.contains("attachmentsClearedStatus: \"Attachments cleared\""))
        #expect(enchantedQtRuntime.contains("attachmentRemovedEmptyStatus: \"Ready\""))
        ...
        #expect(enchantedQtRuntime.contains("attachmentDefaultPromptPlural: \"Describe these images.\""))
    ...
    func enchantedQtHostFollowsMacOSVisualAndInteractionContract() throws {
        ...
        #expect(enchantedQtRuntime.contains("completionsTitle: \"Completions\""))
        #expect(enchantedQtRuntime.contains("shortcutsTitle: \"Shortcuts\""))
        #expect(enchantedQtRuntime.contains("settingsTitle: \"Settings\""))
        ...
        #expect(enchantedMacRoot.contains("Text(\"Drop image files to attach\")"))
        ...
        #expect(enchantedQtRuntime.contains("dropTargetTitle: \"Drop image files to attach\""))
