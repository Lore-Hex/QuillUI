...
struct SourceHygieneTests {
    ...
    func linuxInteractionSmokeTargetsShareOneViewSurface() throws {
        ...
        #expect(enchantedQtRuntime.contains("context.insert(ChatMessage(conversationID: conversationID, role: .user, content: prompt))"))
        ...
        #expect(enchantedQtHost.contains("label(messageRoleTitle(role), QStringLiteral(\"messageRole\"))"))
        ...
        #expect(enchantedQtHost.contains("sendButton->setEnabled(isLoading || hasTrimmedText(promptEditor) || !pendingAttachmentSummary.isEmpty())"))
        ...
        #expect(enchantedQtHost.contains("std::function<bool(const QString &, const QString &, const QString &)> requestHistoryAction"))
        ...
        #expect(enchantedQtHost.contains("requestHistoryAction(QStringLiteral(\"newConversation\"), QString(), QString())"))
        #expect(enchantedQtHost.contains("requestHistoryAction(QStringLiteral(\"deleteConversation\"), deletedConversationID, QString())"))
        #expect(enchantedQtHost.contains("requestHistoryAction(QStringLiteral(\"deleteAllConversations\"), QString(), QString())"))
