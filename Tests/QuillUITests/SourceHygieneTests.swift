...
struct SourceHygieneTests {
    ...
    func linuxInteractionSmokeTargetsShareOneViewSurface() throws {
        ...
        #expect(backendScript.contains("quill-wireguard) INTERACTION_MODE=\"tunnel-name-edit\""))
        ...
        #expect(backendScript.contains("Unsupported generic GTK interaction mode"))
        ...
        #expect(smokeLib.contains("QUILLUI_CODEEDIT_SELECTED_FILE_INDEX_ON_START:-${QUILLUI_GENERIC_QT_SELECTED_INDEX_ON_START:-0}"))
        #expect(smokeLib.contains("QUILLUI_ICECUBES_SELECTED_TIMELINE_INDEX_ON_START:-${QUILLUI_GENERIC_QT_SELECTED_INDEX_ON_START:-0}"))
        #expect(smokeLib.contains("QUILLUI_IINA_SELECTED_PLAYLIST_INDEX_ON_START:-${QUILLUI_GENERIC_QT_SELECTED_INDEX_ON_START:-0}"))
        #expect(smokeLib.contains("QUILLUI_NETNEWSWIRE_SELECTED_FEED_INDEX_ON_START:-${QUILLUI_GENERIC_QT_SELECTED_INDEX_ON_START:-0}"))
        #expect(smokeLib.contains("QUILLUI_SIGNAL_SELECTED_THREAD_INDEX_ON_START:-${QUILLUI_CHAT_SELECTED_THREAD_INDEX_ON_START:-${QUILLUI_GENERIC_QT_SELECTED_INDEX_ON_START:-0}}"))
        #expect(smokeLib.contains("QUILLUI_TELEGRAM_SELECTED_THREAD_INDEX_ON_START:-${QUILLUI_CHAT_SELECTED_THREAD_INDEX_ON_START:-${QUILLUI_GENERIC_QT_SELECTED_INDEX_ON_START:-0}}"))
        ...
        #expect(smokeLib.contains("QUILLUI_SIGNAL_SELECTED_THREAD_INDEX_ON_START=${QUILLUI_SIGNAL_SELECTED_THREAD_INDEX_ON_START:-${QUILLUI_CHAT_SELECTED_THREAD_INDEX_ON_START:-1}}"))
        #expect(smokeLib.contains("QUILLUI_TELEGRAM_SELECTED_THREAD_INDEX_ON_START=${QUILLUI_TELEGRAM_SELECTED_THREAD_INDEX_ON_START:-${QUILLUI_CHAT_SELECTED_THREAD_INDEX_ON_START:-1}}"))
        ...
        #expect(screenshotVerifier.contains("quill-signal-list-selection"))
        #expect(screenshotVerifier.contains("quill-telegram-list-selection"))
    ...
    func generatedLinuxAppPackagesCanLaunchThroughBackendFacades() throws {
        ...
        #expect(source.contains("QT_NATIVE_CATALOG_ENTRY=\"${QUILLUI_GENERATED_QT_NATIVE_CATALOG_ENTRY:-QuillGenericQtAppCatalog.quillChat}\""))
