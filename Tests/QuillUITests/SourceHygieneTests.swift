...
struct SourceHygieneTests {
    ...
    func enchantedQtHostFollowsMacOSVisualAndInteractionContract() throws {
        ...
        #expect(enchantedQtHost.contains("stringValue(payload, \"attachmentsClearedStatus\", QStringLiteral(\"Attachments cleared\"))"))
        #expect(enchantedQtHost.contains("stringValue(payload, \"attachmentRemovedEmptyStatus\", QStringLiteral(\"Ready\"))"))
