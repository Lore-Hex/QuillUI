...
struct SourceHygieneTests {
    ...
    func enchantedQtHostFollowsMacOSVisualAndInteractionContract() throws {
        ...
        #expect(enchantedQtHost.contains("payloadString(payload, \"attachmentPlaceholder\")"))
        ...
        #expect(enchantedQtHost.contains("payloadString(payload, \"clearAttachmentsTitle\")"))
        ...
        #expect(enchantedQtHost.contains("QPushButton *clearAttachmentsButton = new QPushButton(payloadString(payload, \"clearAttachmentsTitle\"))"))
        ...
        #expect(enchantedQtHost.contains("payloadString(payload, \"composerPlaceholder\")"))
