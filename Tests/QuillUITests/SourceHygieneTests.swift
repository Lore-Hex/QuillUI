...
struct SourceHygieneTests {
    ...
    func enchantedQtHostFollowsMacOSVisualAndInteractionContract() throws {
        ...
        #expect(enchantedQtHost.contains("QStringList attachmentCandidatePathsFromMimeData(const QMimeData *mimeData)"))
        ...
        #expect(enchantedQtHost.contains("QStringLiteral(\"tif\")"))
        #expect(enchantedQtHost.contains("QStringLiteral(\"tiff\")"))
        ...
        #expect(enchantedQtHost.contains("AttachmentPathValidation validatedAttachmentPaths(const QStringList &rawPaths)"))
        #expect(enchantedQtHost.contains("const AttachmentPathValidation validation = validatedAttachmentPaths(rawPaths)"))
        #expect(enchantedQtHost.contains("is not a supported image attachment."))
        #expect(enchantedQtHost.contains("Could not read image attachment at %1."))
        #expect(enchantedQtHost.contains("is too large to attach (%2)."))
        ...
        #expect(enchantedQtHost.contains("attachmentCandidatePathsFromMimeData(event->mimeData())"))
