...
struct SourceHygieneTests {
    ...
    func enchantedQtHostFollowsMacOSVisualAndInteractionContract() throws {
        ...
        #expect(enchantedMacRoot.contains("if model.isAttachmentDropTargeted"))
        ...
        #expect(enchantedQtHost.contains("attachButton->setEnabled(hasAttachmentPathInput)"))
        #expect(enchantedQtHost.contains("clearAttachmentsButton->setEnabled(hasAttachmentPathInput || hasPendingAttachments)"))
