...
struct SourceHygieneTests {
    ...
    func linuxInteractionSmokeTargetsShareOneViewSurface() throws {
        ...
        #expect(genericQtRuntime.contains("private static let selectedIndexEnvironmentKey = \"QUILLUI_GENERIC_QT_SELECTED_INDEX_ON_START\""))
        ...
        #expect(genericQtRuntime.contains("environmentKey: selectedIndexEnvironmentKey"))
