...
"""))
    ...
    func quillDesktopSplitLayoutMirrorsMacReferenceTitlebarChrome() throws {
        ...
        #expect(controls.contains("public final class QuillChatCopySource<Message>"))
        #expect(controls.contains("private var messages: [Message] = []"))
        #expect(controls.contains("public func update(_ messages: [Message])"))
