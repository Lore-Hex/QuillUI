...
struct SourceHygieneTests {
    ...
    func enchantedQtHostFollowsMacOSVisualAndInteractionContract() throws {
        ...
        #expect(enchantedQtHost.contains("return QStringLiteral(\"%1 %2\").arg(usingModelStatusPrefix, trimmedModel)"))
        #expect(enchantedQtHost.contains("modelStatusText(payloadString(payload, \"selectedModel\"), chooseLocalModelStatus, usingModelStatusPrefix)"))
        ...
        #expect(enchantedQtHost.contains("modelStatus->setText(modelStatusText(model, chooseLocalModelStatus, usingModelStatusPrefix))"))
