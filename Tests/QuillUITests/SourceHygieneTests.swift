...
struct SourceHygieneTests {
    ...
    func enchantedQtHostFollowsMacOSVisualAndInteractionContract() throws {
        ...
        #expect(enchantedQtHost.contains(".arg(dropTarget, dropTargetBorder, primary, divider, dropTargetRadius, captionFontSize)"))
        ...
        #expect(enchantedQtHost.contains("QLabel#dropTargetLabel { color: %3; font-size: %6; }"))
        #expect(enchantedQtHost.contains("QFrame *dropHint = QuillQtWidgets::frame(QStringLiteral(\"dropTargetHint\"))"))
