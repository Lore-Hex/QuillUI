...
struct SourceHygieneTests {
    ...
    func linuxInteractionSmokeTargetsShareOneViewSurface() throws {
        ...
        #expect(genericQtRuntime.contains("public static func run(_ snapshot: QuillGenericQtAppSnapshot, executableName: String) -> Never"))
        ...
        #expect(!genericQtRuntime.contains("executableName: \"quill-generic-qt\""))
