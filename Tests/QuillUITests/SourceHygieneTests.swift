...
"""))
    ...
    func linuxBackendFacadesScriptsAndWorkflowsStayBackendNeutral() throws {
        ...
        #expect(solderScopeSmoke.contains("quillui_solderscope_wait_for_recording_ui_settled()"))
        #expect(solderScopeSmoke.contains("QUILLUI_SOLDERSCOPE_RECORDING_UI_SETTLE_SECONDS:-8"))
        #expect(solderScopeSmoke.contains("QUILLUI_SOLDERSCOPE_RECORDING_UI_SETTLE_TICK_SECONDS:-0.5"))
