...
struct SourceHygieneTests {
    ...
    func enchantedQtHostFollowsMacOSVisualAndInteractionContract() throws {
        ...
        #expect(enchantedQtHost.contains("statusText->setText(validation.lastError)"))
        ...
        #expect(enchantedQtHost.contains("statusText->setText(payloadString(payload, \"status\"));\n        discardUnsupportedAttachmentState();"))
