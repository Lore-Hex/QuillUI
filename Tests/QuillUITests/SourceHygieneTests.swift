...
struct SourceHygieneTests {
    ...
    func enchantedQtHostFollowsMacOSVisualAndInteractionContract() throws {
        ...
        #expect(enchantedQtHost.contains("QPushButton *deleteButton = new QPushButton(deleteChatTitle)"))
        #expect(enchantedQtHost.contains("deleteButton->setAccessibleName(deleteChatTitle)"))
        #expect(enchantedQtHost.contains("deleteButton->setAccessibleDescription(deleteChatTitle)"))
        #expect(enchantedQtHost.contains("deleteButton->setToolTip(deleteChatTitle)"))
        #expect(enchantedQtHost.contains("deleteButton->setStatusTip(deleteChatTitle)"))
        ...
        #expect(enchantedMacRoot.contains("Button(EnchantedCopy.deleteChatTitle)"))
        #expect(enchantedMacRoot.contains("model.deleteSelectedConversation()"))
        #expect(enchantedMacRoot.contains("Button(EnchantedCopy.clearAllTitle)"))
