...
struct SourceHygieneTests {
    ...
    func linuxInteractionSmokeTargetsShareOneViewSurface() throws {
        ...
        #expect(backendVisualScript.contains("quillui_export_backend_argument \"${3:-}\""))
        ...
        #expect(smokeLib.contains("QUILLUI_BACKEND=\"$(quillui_backend_identifier_or_raw \"$requested_backend\")\""))
        ...
        #expect(smokeLib.contains("requested_backend=\"$(quillui_backend_identifier_or_raw \"$requested_backend\")\""))
        ...
        #expect(backendProducts.contains("quillui_backend_app_products | quillui_backend_matrix_for_products"))
        ...
        #expect(backendProducts.contains("quillui_backend_generated_app_products | quillui_backend_matrix_for_products"))
        ...
        #expect(workflow.contains("scripts/quillui-backend-products.sh smoke-matrix"))
