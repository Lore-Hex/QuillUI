...
"""))
    ...
    func linuxBackendFacadesScriptsAndWorkflowsStayBackendNeutral() throws {
        ...
        #expect(smokeLib.contains("enchanted_artifact_path_file=\"${QUILLUI_BACKEND_APP_ARTIFACT_PATH_FILE:-$enchanted_work_root/.quillui-artifact-path}\""))
        #expect(smokeLib.contains("QUILLUI_APP_ARTIFACT_PATH_FILE=\"$enchanted_artifact_path_file\""))
        #expect(smokeLib.contains("Generated app build did not write a usable artifact path for $product: $enchanted_artifact_path_file"))
    ...
    func generatedLinuxAppPackagesCanLaunchThroughBackendFacades() throws {
        ...
        #expect(source.contains("QUILLUI_RUNTIME_ONLY_MACROS=\"${QUILLUI_RUNTIME_ONLY_MACROS:-1}\" QUILLUI_LINUX_BACKEND=qt \"$ROOT_DIR/scripts/swiftpm-preserve-package-resolved.sh\" swift build"))
        #expect(source.contains("QUILLUI_RUNTIME_ONLY_MACROS=\"${QUILLUI_RUNTIME_ONLY_MACROS:-1}\" QUILLUI_LINUX_BACKEND=gtk \"$ROOT_DIR/scripts/swiftpm-preserve-package-resolved.sh\" swift build"))
