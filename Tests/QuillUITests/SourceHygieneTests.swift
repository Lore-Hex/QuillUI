...
struct SourceHygieneTests {
    ...
    func enchantedQtHostFollowsMacOSVisualAndInteractionContract() throws {
        ...
        #expect(enchantedQtHost.contains("QIcon promptButtonIcon()"))
        ...
        #expect(enchantedQtHost.contains("QLabel *promptIcon = iconLabel(promptButtonIcon(), QStringLiteral(\"promptButtonIcon\"), style)"))
