...
"""))
    ...
    func linuxBackendFacadesScriptsAndWorkflowsStayBackendNeutral() throws {
        ...
        #expect(solderScopeSmoke.contains("QUILLUI_SOLDERSCOPE_RECORDING_STOP_FALLBACK_DRIVER"))
        #expect(solderScopeSmoke.contains("QUILLUI_SOLDERSCOPE_RECORDING_STOP_FALLBACK_TICK:-48"))
        ...
        #expect(solderScopeSmoke.contains("QUILLUI_SOLDERSCOPE_RECORDING_STOP_RETRY_TICK:-40"))
...
"""))
    ...
    func completionsScreenshotVerifierRequiresTrailingControls() throws {
        ...
        #expect(verifier.contains("minimum_row_dividers=3"))
        #expect(verifier.contains("minimum_row_action_segments=6"))
