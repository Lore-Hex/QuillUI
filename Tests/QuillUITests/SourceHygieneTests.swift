...
struct SourceHygieneTests {
    ...
    func linuxInteractionSmokeTargetsShareOneViewSurface() throws {
        ...
        #expect(enchantedQtRuntime.contains("sidebarPadding: 18"))
        #expect(enchantedQtRuntime.contains("sidebarSpacing: 14"))
        #expect(enchantedQtRuntime.contains("statusRowSpacing: 8"))
        #expect(enchantedQtRuntime.contains("statusDotSize: 9"))
        #expect(enchantedQtRuntime.contains("statusDotRadius: 9"))
        #expect(enchantedQtRuntime.contains("conversationRowPadding: 11"))
        #expect(enchantedQtRuntime.contains("conversationRowSpacing: 5"))
        #expect(enchantedQtRuntime.contains("conversationActionsSpacing: 8"))
        #expect(enchantedQtRuntime.contains("attachmentChipPadding: 8"))
        #expect(enchantedQtRuntime.contains("attachmentChipSpacing: 8"))
        #expect(enchantedQtRuntime.contains("attachmentChipTextSpacing: 2"))
        #expect(enchantedQtRuntime.contains("attachmentTraySpacing: 7"))
        #expect(enchantedQtRuntime.contains("attachmentTrayChipSpacing: 8"))
        #expect(enchantedQtRuntime.contains("attachmentInputHorizontalPadding: 10"))
        #expect(enchantedQtRuntime.contains("attachmentInputVerticalPadding: 7"))
        #expect(enchantedQtRuntime.contains("attachmentInputSpacing: 8"))
        #expect(enchantedQtRuntime.contains("headerTitleWidth: 560"))
        #expect(enchantedQtRuntime.contains("headerSpacing: 12"))
        #expect(enchantedQtRuntime.contains("headerTitleSpacing: 4"))
        #expect(enchantedQtRuntime.contains("composerPadding: 18"))
        #expect(enchantedQtRuntime.contains("composerSpacing: 10"))
        #expect(enchantedQtRuntime.contains("promptRowSpacing: 12"))
        #expect(enchantedQtRuntime.contains("composerMinHeight: 74"))
        #expect(enchantedQtRuntime.contains("composerMaxHeight: 120"))
        #expect(enchantedQtRuntime.contains("messageSpacing: 14"))
        #expect(enchantedQtRuntime.contains("messageBubbleRowSpacing: 10"))
        #expect(enchantedQtRuntime.contains("messageBubblePadding: 13"))
        #expect(enchantedQtRuntime.contains("messageBubbleSpacing: 7"))
        ...
        #expect(enchantedQtRuntime.contains("emptyStatePadding: 26"))
        #expect(enchantedQtRuntime.contains("emptyStateSpacing: 18"))
        #expect(enchantedQtRuntime.contains("emptyStateMaxWidth: 680"))
        #expect(enchantedQtRuntime.contains("promptListSpacing: 10"))
        #expect(enchantedQtRuntime.contains("promptButtonMinHeight: 48"))
        #expect(enchantedQtRuntime.contains("promptButtonWidth: 620"))
        ...
        #expect(enchantedQtHost.contains("border-radius: %10;"))
        ...
        #expect(enchantedQtHost.contains("QFrame#conversationRow[active=\"true\"] { background: %8; }"))
        ...
        #expect(enchantedQtHost.contains(".arg(quoteRule, codeBlock)"))
        ...
        #expect(enchantedQtHost.contains("QFrame#messageSystem { background: %7;"))
        #expect(enchantedQtHost.contains("QFrame#messageUser { background: %6;"))
        #expect(enchantedQtHost.contains("border-radius: 10px;"))
        ...
        #expect(enchantedQtHost.contains(".arg(selected, ink, card, success, warning, dropTarget, canvas, primary, statusDotSize, statusDotRadius)"))
        ...
        #expect(enchantedQtRuntime.contains("attachmentRemoveButtonWidth: 28"))
        ...
        #expect(enchantedQtRuntime.contains("composerSendButtonMinWidth: 86"))
