...
struct SourceHygieneTests {
    ...
    func publicDocsDescribeBackendNeutralAppMatrix() throws {
        ...
        #expect(uiTestPlan.contains("GTK import modes currently use the generic screenshot"))
        #expect(uiTestPlan.contains("health checks until a GTK-specific WireGuard import predicate lands"))
    ...
    func linuxInteractionSmokeTargetsShareOneViewSurface() throws {
        ...
        #expect(backendScript.contains("import_configuration=\"$(wireguard_import_configuration)\" || exit $?"))
