...
"""))
    ...
    func quillDesktopSplitLayoutMirrorsMacReferenceTitlebarChrome() throws {
        ...
        #expect(controls.contains("rememberedCommandBridge.install(key: key, clipboard: clipboard)"))
        ...
        #expect(controls.contains("guard let payload = rememberedPayloads.value(forKey: key) else { return false }"))
        ...
        #expect(controls.contains("quill.chat-copy-command-bridge"))
