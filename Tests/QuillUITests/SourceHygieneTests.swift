...
struct SourceHygieneTests {
    ...
    func enchantedQtHostFollowsMacOSVisualAndInteractionContract() throws {
        ...
        #expect(enchantedQtHost.contains("sidebarTitleLayout->setSpacing(intValue(style, \"sidebarTitleSpacing\", 4))"))
        #expect(enchantedQtHost.contains("void addSidebarField(\n    QVBoxLayout *layout,\n    const QString &title,\n    QWidget *field,\n    const QJsonObject &style\n)"))
        #expect(enchantedQtHost.contains("groupLayout->setSpacing(intValue(style, \"sidebarControlGroupSpacing\", 7))"))
        ...
        #expect(enchantedQtHost.contains("list->setSpacing(intValue(style, \"conversationListSpacing\", 8))"))
        ...
        #expect(enchantedQtHost.contains("const int dropTargetPadding = intValue(style, \"dropTargetPadding\", 8)"))
        ...
        #expect(enchantedQtHost.contains("const int promptButtonWidth = intValue(style, \"promptButtonWidth\", 620)"))
        ...
        #expect(enchantedQtHost.contains("composerContent->setMinimumWidth(intValue(style, \"composerMinWidth\", 620))"))
        #expect(enchantedQtHost.contains("composerContent->setMaximumWidth(intValue(style, \"composerMaxWidth\", 840))"))
        ...
        #expect(enchantedQtHost.contains("styleValue(style, \"quoteRuleColor\", \"#D8D8DE\")"))
        #expect(enchantedQtHost.contains("styleValue(style, \"codeBlockColor\", \"#F4F4F6\")"))
        ...
        #expect(enchantedQtHost.contains("headerLayout->setSpacing(intValue(style, \"emptyStateHeaderSpacing\", 8))"))
        #expect(enchantedQtHost.contains("const int promptButtonIconSpacing = intValue(style, \"promptButtonIconSpacing\", 10)"))
        #expect(enchantedQtHost.contains("const int promptButtonTextWidth = promptButtonWidth - intValue(style, \"promptButtonTextWidthInset\", 80)"))
        ...
        #expect(enchantedQtHost.contains("return intValue(style, \"actionButtonIconSize\", 16)"))
