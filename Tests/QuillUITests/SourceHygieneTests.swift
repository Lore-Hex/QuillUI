...
struct SourceHygieneTests {
    ...
    func enchantedQtHostFollowsMacOSVisualAndInteractionContract() throws {
        ...
        #expect(enchantedQtHost.contains("void applyActionAccessibility(QAction *action, const QString &title)"))
        #expect(enchantedQtHost.contains("action->setToolTip(title);\n    action->setStatusTip(title);\n    action->setWhatsThis(title)"))
        #expect(enchantedQtHost.contains("copyAction->setIcon(copyMessageActionIcon(icons))"))
        #expect(enchantedQtHost.contains("applyActionAccessibility(copyAction, copyMessageTitle)"))
        ...
        #expect(enchantedQtHost.contains("applyActionAccessibility(editAction, editMessageTitle)"))
        ...
        #expect(enchantedQtHost.contains("applyActionAccessibility(unselectAction, unselectMessageTitle)"))
