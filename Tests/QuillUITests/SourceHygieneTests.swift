...
"""))
    ...
    func upstreamIceCubesVisualSmokeIsFirstClassLinuxArtifact() throws {
        ...
        #expect(script.contains("AUTH_STATUS_DETAIL_REPLY_Y=\"${QUILLUI_ICECUBES_VISUAL_AUTH_STATUS_DETAIL_REPLY_Y:-462}\""))
        #expect(script.contains("local verify_product=\"${1:-icecubes-linux-authenticated-composer}\""))
        ...
        #expect(script.contains("AUTH_STATUS_DETAIL_BOOST_Y=\"${QUILLUI_ICECUBES_VISUAL_AUTH_STATUS_DETAIL_BOOST_Y:-462}\""))
        #expect(script.contains("AUTH_STATUS_DETAIL_BOOST_POINTS=\"${QUILLUI_ICECUBES_VISUAL_AUTH_STATUS_DETAIL_BOOST_POINTS:-$AUTH_STATUS_DETAIL_BOOST_X,$AUTH_STATUS_DETAIL_BOOST_Y 350,$AUTH_STATUS_DETAIL_BOOST_Y"))
        #expect(script.contains("AUTH_STATUS_DETAIL_BOOST_MENU_Y=\"${QUILLUI_ICECUBES_VISUAL_AUTH_STATUS_DETAIL_BOOST_MENU_Y:-505}\""))
        #expect(script.contains("AUTH_STATUS_DETAIL_BOOST_MENU_POINTS=\"${QUILLUI_ICECUBES_VISUAL_AUTH_STATUS_DETAIL_BOOST_MENU_POINTS:-$AUTH_STATUS_DETAIL_BOOST_MENU_X,$AUTH_STATUS_DETAIL_BOOST_MENU_Y 320,$AUTH_STATUS_DETAIL_BOOST_MENU_Y"))
        ...
        #expect(script.contains("AUTH_STATUS_DETAIL_QUOTE_MENU_Y=\"${QUILLUI_ICECUBES_VISUAL_AUTH_STATUS_DETAIL_QUOTE_MENU_Y:-557}\""))
        ...
        #expect(script.contains("AUTH_STATUS_DETAIL_FAVORITE_POINTS=\"${QUILLUI_ICECUBES_VISUAL_AUTH_STATUS_DETAIL_FAVORITE_POINTS:-$AUTH_STATUS_DETAIL_FAVORITE_X,$AUTH_STATUS_DETAIL_FAVORITE_Y 412,$AUTH_STATUS_DETAIL_FAVORITE_Y"))
        ...
        #expect(script.contains("AUTH_STATUS_DETAIL_BOOKMARK_X=\"${QUILLUI_ICECUBES_VISUAL_AUTH_STATUS_DETAIL_BOOKMARK_X:-583}\""))
        #expect(script.contains("AUTH_STATUS_DETAIL_BOOKMARK_POINTS=\"${QUILLUI_ICECUBES_VISUAL_AUTH_STATUS_DETAIL_BOOKMARK_POINTS:-$AUTH_STATUS_DETAIL_BOOKMARK_X,$AUTH_STATUS_DETAIL_BOOKMARK_Y 596,$AUTH_STATUS_DETAIL_BOOKMARK_Y"))
