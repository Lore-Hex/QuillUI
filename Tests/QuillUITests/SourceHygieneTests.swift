...
struct SourceHygieneTests {
    ...
    func enchantedQtHostFollowsMacOSVisualAndInteractionContract() throws {
        ...
        #expect(enchantedMacRoot.contains("Image(systemName: \"square.and.pencil\")"))
        #expect(enchantedMacRoot.contains("EnchantedVisualMetrics.primaryButtonIconSpacing"))
        #expect(enchantedQtHost.contains("QIcon newConversationButtonIcon()"))
        ...
        #expect(enchantedQtHost.contains("newConversationButton->setIcon(newConversationButtonIcon())"))
        ...
        #expect(enchantedMacRoot.contains("Image(systemName: \"folder.badge.plus\")"))
        #expect(enchantedMacRoot.contains("Button(EnchantedCopy.clearAttachmentsTitle)"))
        #expect(enchantedMacRoot.contains("Image(systemName: model.isLoading ? \"square.fill\" : \"arrow.forward.circle.fill\")"))
        ...
        #expect(enchantedQtHost.contains("attachButton->setIcon(attachButtonIcon())"))
        ...
        #expect(enchantedQtHost.contains("QIcon dropTargetIcon()"))
        #expect(enchantedQtHost.contains("return attachButtonIcon()"))
        #expect(enchantedQtHost.contains("QLabel *dropTargetIconLabel = iconLabel("))
        #expect(enchantedQtHost.contains("dropTargetIcon(),\n        QStringLiteral(\"dropTargetIcon\"),\n        style"))
        ...
        #expect(enchantedQtHost.contains("QIcon sendButtonIcon(bool isLoading)"))
        ...
        #expect(enchantedQtHost.contains("updateSendButtonPresentation(sendButton, isLoading, sendTitle, stopTitle)"))
