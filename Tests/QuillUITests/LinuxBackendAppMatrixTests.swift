...
struct LinuxBackendAppMatrixTests {
    ...
    func coversEachUserFacingAppProductOnce() throws {
        ...
        #expect(profileScript.contains("quillui_append_backend_launch_environment app_environment \"$PRODUCT\" \"$display_id\""))
        ...
        #expect(profileScript.contains("quillui_append_quill_chat_reference_environment_if_needed"))
        ...
        #expect(visualScript.contains("quillui_append_backend_launch_environment app_environment \"$PRODUCT\" \"$DISPLAY_ID\""))
        #expect(visualScript.contains("quillui_append_quill_chat_reference_environment_if_needed"))
        #expect(visualScript.contains("quillui_backend_visual_verify_product \"$PRODUCT\" VERIFY_PRODUCT"))
        #expect(visualScript.contains("QUILLUI_BACKEND_LAYOUT_DEBUG=\"$QUILLUI_BACKEND_LAYOUT_DEBUG\""))
        #expect(visualScript.contains("QUILLUI_GTK_LAYOUT_DEBUG=\"$QUILLUI_BACKEND_LAYOUT_DEBUG\""))
        #expect(visualScript.contains("QUILLUI_QT_LAYOUT_DEBUG=\"$QUILLUI_BACKEND_LAYOUT_DEBUG\""))
