...
struct LinuxBackendAppMatrixTests {
    ...
    func coversEachUserFacingAppProductOnce() throws {
        ...
        #expect(profileScript.contains("quillui_append_backend_layout_debug_environment app_environment \"${QUILLUI_BACKEND_LAYOUT_DEBUG:-}\""))
        ...
        #expect(visualScript.contains("quillui_append_backend_layout_debug_environment app_environment \"${QUILLUI_BACKEND_LAYOUT_DEBUG:-}\""))
