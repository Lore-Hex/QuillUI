...
struct LinuxBackendAppMatrixTests {
    ...
    func coversEachUserFacingAppProductOnce() throws {
        ...
        #expect(profileScript.contains("quillui_is_quill_chat_mac_reference_product \"$PRODUCT\""))
        #expect(profileScript.contains("quillui_append_quill_chat_reference_environment"))
