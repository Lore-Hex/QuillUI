...
struct CoreContractMatrixTests {
    ...
    func enchantedQtNativeTargetContracts() throws {
        ...
        expectContains(runtime, "noMessagesYet: EnchantedCopy.noMessagesYet")
        ...
        expectContains(nativeShim, "styleInt(style, \"sidebarWidth\")")
        ...
        expectContains(nativeShim, "layout->setSpacing(styleInt(style, \"conversationRowSpacing\"))")
        expectContains(nativeShim, "stringValue(conversation, \"title\", newConversationTitle)")
        expectContains(nativeShim, "const QString previewText = stringValue(conversation, \"lastMessage\", noMessagesYet)")
        ...
        expectContains(nativeShim, "conversationActions->setSpacing(styleInt(style, \"conversationActionsSpacing\"))")
        ...
        expectContains(nativeShim, "dropLayout->setSpacing(styleInt(style, \"attachmentInputSpacing\"))")
        ...
        expectContains(nativeShim, "styleInt(style, \"headerTitleWidth\")")
        expectContains(nativeShim, "statusLayout->setSpacing(styleInt(style, \"statusRowSpacing\"))")
        expectContains(nativeShim, "statusText->setFixedWidth(styleInt(style, \"statusTextWidth\"))")
        ...
        expectContains(nativeShim, "headerLayout->setSpacing(styleInt(style, \"headerSpacing\"))")
        expectContains(nativeShim, "titleLayout->setSpacing(styleInt(style, \"headerTitleSpacing\"))")
        expectContains(nativeShim, "messageLayout->setSpacing(styleInt(style, \"messageSpacing\"))")
        ...
        expectContains(nativeShim, "row->setSpacing(styleInt(style, \"messageBubbleRowSpacing\"))")
        expectContains(nativeShim, "const int messageBubblePadding = styleInt(style, \"messageBubblePadding\")")
        expectContains(nativeShim, "layout->setContentsMargins(\n        messageBubblePadding,\n        messageBubblePadding,\n        messageBubblePadding,\n        messageBubblePadding\n    )")
        expectContains(nativeShim, "layout->setSpacing(styleInt(style, \"messageBubbleSpacing\"))")
        ...
        expectContains(nativeShim, "button->setMinimumHeight(styleInt(style, \"promptButtonMinHeight\"))")
        ...
        expectContains(nativeShim, "QPlainTextEdit { background: %1; color: %2; border: 1px solid %3; border-radius: %6; padding: %5; }")
        ...
        expectContains(nativeShim, "const QString chooseLocalModelStatus = stringValue(payload, \"chooseLocalModelStatus\")")
        expectContains(nativeShim, "const QString usingModelStatusPrefix = stringValue(payload, \"usingModelStatusPrefix\")")
        expectContains(nativeShim, "const QString newConversationButtonTitle = stringValue(payload, \"newConversationButtonTitle\")")
        ...
        expectContains(nativeShim, "app.setApplicationName(stringValue(payload, \"windowTitle\"))")
        expectContains(nativeShim, "window.setWindowTitle(stringValue(payload, \"windowTitle\"))")
        expectContains(nativeShim, "stringValue(payload, \"sidebarTitle\")")
        expectContains(nativeShim, "stringValue(payload, \"sidebarSubtitle\")")
        expectContains(nativeShim, "stringValue(payload, \"endpointLabel\")")
        expectContains(nativeShim, "const QString modelLabel = stringValue(payload, \"modelLabel\")")
        expectContains(nativeShim, "stringValue(payload, \"conversationsTitle\")")
        expectContains(nativeShim, "QPushButton *deleteButton = new QPushButton(stringValue(payload, \"deleteChatTitle\"))")
        expectContains(nativeShim, "QPushButton *completionsButton = new QPushButton(stringValue(payload, \"completionsTitle\"))")
        expectContains(nativeShim, "QPushButton *shortcutsButton = new QPushButton(stringValue(payload, \"shortcutsTitle\"))")
        expectContains(nativeShim, "QPushButton *settingsButton = new QPushButton(stringValue(payload, \"settingsTitle\"))")
        expectContains(nativeShim, "QPushButton *refreshButton = new QPushButton(stringValue(payload, \"refreshModelsTitle\"))")
        ...
        expectContains(nativeShim, "stringValue(payload, \"completionsPanelSubtitle\")")
        expectContains(nativeShim, "stringValue(payload, \"shortcutsPanelSubtitle\")")
        expectContains(nativeShim, "stringValue(payload, \"settingsPanelSubtitle\")")
        expectContains(nativeShim, "stringValue(payload, \"completionsStatus\")")
        expectContains(nativeShim, "stringValue(payload, \"shortcutsStatus\")")
        expectContains(nativeShim, "stringValue(payload, \"settingsStatus\")")
        ...
        expectContains(nativeShim, "const QString newConversationTitle = stringValue(payload, \"newConversationTitle\")")
        expectContains(nativeShim, "const QString noMessagesYet = stringValue(payload, \"noMessagesYet\")")
        expectContains(nativeShim, "const QString userRoleLabel = stringValue(payload, \"userRoleLabel\")")
        expectContains(nativeShim, "const QString assistantRoleLabel = stringValue(payload, \"assistantRoleLabel\")")
        expectContains(nativeShim, "const QString systemRoleLabel = stringValue(payload, \"systemRoleLabel\")")
        ...
        expectContains(nativeShim, "return QStringLiteral(\"%1 %2\").arg(usingModelStatusPrefix, trimmedModel)")
        expectContains(nativeShim, "modelStatusText(stringValue(payload, \"selectedModel\"), chooseLocalModelStatus, usingModelStatusPrefix)")
        ...
        expectContains(nativeShim, "layout->setSpacing(styleInt(style, \"markdownListItemSpacing\"))")
        expectContains(nativeShim, "markerLabel->setFixedWidth(styleInt(style, \"markdownNumberWidth\"))")
        ...
        expectContains(nativeShim, "layout->setSpacing(styleInt(style, \"markdownQuoteSpacing\"))")
        expectContains(nativeShim, "rule->setFixedWidth(styleInt(style, \"markdownQuoteRuleWidth\"))")
        ...
        expectContains(nativeShim, "layout->setSpacing(styleInt(style, \"markdownCodeBlockSpacing\"))")
        ...
        expectContains(nativeShim, "layout->setSpacing(styleInt(style, \"markdownBlockSpacing\"))")
        expectContains(nativeShim, "addMarkdownBlocks(layout, markdown, style)")
        expectContains(nativeShim, "layout->addWidget(markdownMessageWidget(stringValue(message, \"content\"), style))")
        ...
        expectContains(nativeShim, "stringValue(payload, \"noModelsTitle\")")
        ...
        expectContains(nativeShim, "populateModelPicker(models, stringValue(payload, \"selectedModel\"))")
        ...
        expectContains(nativeShim, "stringValue(payload, \"clearAllTitle\")")
        ...
        expectDoesNotContain(nativeShim, "layout->setSpacing(8)")
        expectContains(nativeShim, "stringValue(payload, \"emptyHistoryTitle\")")
        expectContains(nativeShim, "stringValue(payload, \"emptyHistorySubtitle\")")
        ...
        expectContains(macOSRootView, "model.isAttachmentDropTargeted = isTargeted")
        ...
        for needle in [
            "stringValue(payload, \"attachmentPlaceholder\")",
            "stringValue(payload, \"attachTitle\")",
            "stringValue(payload, \"clearAttachmentsTitle\")",
            "stringValue(payload, \"attachmentsClearedStatus\")",
            "stringValue(payload, \"attachmentRemovedEmptyStatus\")",
            "stringValue(payload, \"attachmentsTitle\")",
            "stringValue(payload, \"attachmentDefaultPrompt\")",
            "stringValue(payload, \"attachmentDefaultPromptPlural\")",
            "stringValue(payload, \"attachmentSummaryTitle\")",
        ...
        expectContains(macOSRootView, "if model.isAttachmentDropTargeted")
        ...
        expectContains(nativeShim, "stringValue(payload, \"dropTargetTitle\")")
        ...
        expectContains(nativeShim, "boolValue(payload, \"isLoading\", false)")
        expectContains(nativeShim, "stringValue(payload, \"sendTitle\")")
        expectDoesNotContain(nativeShim, "QStringLiteral(\"Send\")")
        expectContains(nativeShim, "stringValue(payload, \"stopTitle\")")
        expectDoesNotContain(nativeShim, "QStringLiteral(\"Stop\")")
        expectContains(nativeShim, "stringValue(payload, \"stoppingStatus\")")
        expectDoesNotContain(nativeShim, "QStringLiteral(\"Stopping...\")")
        expectContains(nativeShim, "stringValue(payload, \"removeAttachmentTooltip\")")
        expectDoesNotContain(nativeShim, "QStringLiteral(\"Remove attachment\")")
        expectContains(nativeShim, "stringValue(payload, \"imageReadyStatusSingular\")")
        expectDoesNotContain(nativeShim, "QStringLiteral(\"1 image ready to send\")")
        expectContains(nativeShim, "stringValue(payload, \"imageReadyStatusPluralUnit\")")
        ...
        expectContains(nativeShim, "attachButton->setEnabled(hasAttachmentPathInput)")
        expectContains(nativeShim, "clearAttachmentsButton->setEnabled(hasAttachmentPathInput || hasPendingAttachments)")
        ...
        expectContains(nativeShim, "isLoading = boolValue(payload, \"isLoading\", false)")
        expectContains(nativeShim, "refreshStyle(sendButton)")
        expectContains(nativeShim, "refreshStyle(sendButton);\n        updateComposerControlState()")
        expectContains(nativeShim, "modelStatus->setText(modelStatusText(model, chooseLocalModelStatus, usingModelStatusPrefix))")
        ...
        expectContains(nativeShim, "requestHistoryAction(QStringLiteral(\"newConversation\"), QString(), QString(), QStringList())")
        expectContains(nativeShim, "requestHistoryAction(QStringLiteral(\"deleteConversation\"), deletedConversationID, QString(), QStringList())")
        expectContains(nativeShim, "requestHistoryAction(QStringLiteral(\"deleteAllConversations\"), QString(), QString(), QStringList())")
        ...
        expectContains(nativeShim, "stringValue(payload, \"composerPlaceholder\")")
        expectDoesNotContain(nativeShim, "QStringLiteral(\"Ask a local model...\")")
        expectContains(nativeShim, "stringValue(payload, \"emptyStateTitle\")")
        expectDoesNotContain(nativeShim, "QStringLiteral(\"Ask your local model\")")
        expectContains(nativeShim, "stringValue(payload, \"emptyStateSubtitle\")")
