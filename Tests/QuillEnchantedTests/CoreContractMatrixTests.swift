...
struct CoreContractMatrixTests {
    ...
    func enchantedQtNativeTargetContracts() throws {
        ...
        expectContains(nativeShim, "void applyActionAccessibility(QAction *action, const QString &title)")
        expectContains(nativeShim, "action->setToolTip(title);\n    action->setStatusTip(title);\n    action->setWhatsThis(title)")
        ...
        expectContains(nativeShim, "applyActionAccessibility(copyAction, copyMessageTitle)")
        ...
        expectContains(nativeShim, "applyActionAccessibility(editAction, editMessageTitle)")
        ...
        expectContains(nativeShim, "applyActionAccessibility(unselectAction, unselectMessageTitle)")
