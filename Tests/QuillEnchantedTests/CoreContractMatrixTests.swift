...
struct CoreContractMatrixTests {
    ...
    func enchantedQtNativeTargetContracts() throws {
        ...
        expectContains(nativeShim, "QLabel *attachmentName = label(attachmentDisplayName(path), QStringLiteral(\"attachmentName\"));\n            attachmentName->setWordWrap(false)")
        ...
        expectContains(nativeShim, "systemRoleLabel\n    ), 0, Qt::AlignTop)")
