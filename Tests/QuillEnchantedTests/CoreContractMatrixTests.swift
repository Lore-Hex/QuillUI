...
struct CoreContractMatrixTests {
    ...
    func enchantedQtNativeTargetContracts() throws {
        ...
        #expect(runtime.contains("attachmentRemovedEmptyStatus: EnchantedCopy.attachmentRemovedEmptyStatus"))
        ...
        #expect(nativeShim.contains("styleValue(style, \"canvasColor\")"))
        #expect(nativeShim.contains("styleValue(style, \"quoteRuleColor\")"))
        #expect(nativeShim.contains("styleValue(style, \"codeBlockColor\")"))
        #expect(nativeShim.contains("styleValue(style, \"dividerColor\")"))
        #expect(nativeShim.contains("styleValue(style, \"cardBorderColor\")"))
        #expect(nativeShim.contains("styleValue(style, \"messageBorderColor\")"))
        #expect(nativeShim.contains("styleValue(style, \"controlBorderColor\")"))
        #expect(nativeShim.contains("styleValue(style, \"dropTargetBorderColor\")"))
        #expect(nativeShim.contains("styleValue(style, \"disabledButtonBackgroundColor\")"))
        #expect(nativeShim.contains("styleValue(style, \"disabledButtonForegroundColor\")"))
        #expect(nativeShim.contains("styleValue(style, \"disabledTextColor\")"))
        #expect(nativeShim.contains("styleInt(style, \"sidebarWidth\")"))
        #expect(nativeShim.contains("const int sidebarPadding = styleInt(style, \"sidebarPadding\")"))
        #expect(nativeShim.contains("sidebarLayout->setContentsMargins(sidebarPadding, sidebarPadding, sidebarPadding, sidebarPadding)"))
        #expect(nativeShim.contains("sidebarLayout->setSpacing(styleInt(style, \"sidebarSpacing\"))"))
        #expect(nativeShim.contains("QWidget *sidebarTitleBlock = new QWidget()"))
        #expect(nativeShim.contains("sidebarTitleLayout->setSpacing(styleInt(style, \"sidebarTitleSpacing\"))"))
        #expect(nativeShim.contains("void addSidebarField(\n    QVBoxLayout *layout,\n    const QString &title,\n    QWidget *field,\n    const QJsonObject &style\n)"))
        #expect(nativeShim.contains("groupLayout->setSpacing(styleInt(style, \"sidebarControlGroupSpacing\"))"))
        ...
        #expect(nativeShim.contains("const int conversationRowPadding = styleInt(style, \"conversationRowPadding\")"))
        #expect(nativeShim.contains("layout->setContentsMargins(\n        conversationRowPadding,\n        conversationRowPadding,\n        conversationRowPadding,\n        conversationRowPadding\n    )"))
        #expect(nativeShim.contains("layout->setSpacing(styleInt(style, \"conversationRowSpacing\"))"))
        ...
        #expect(nativeShim.contains("conversationActions->setSpacing(styleInt(style, \"conversationActionsSpacing\"))"))
        #expect(!nativeShim.contains("conversationActions->setSpacing(8)"))
        #expect(nativeShim.contains("const int attachmentChipPadding = styleInt(style, \"attachmentChipPadding\")"))
        #expect(nativeShim.contains("attachmentChipLayout->setContentsMargins(\n                attachmentChipPadding,\n                attachmentChipPadding,\n                attachmentChipPadding,\n                attachmentChipPadding\n            )"))
        #expect(nativeShim.contains("attachmentChipLayout->setSpacing(styleInt(style, \"attachmentChipSpacing\"))"))
        #expect(nativeShim.contains("attachmentTextLayout->setSpacing(styleInt(style, \"attachmentChipTextSpacing\"))"))
        ...
        #expect(nativeShim.contains("attachmentTrayLayout->setSpacing(styleInt(style, \"attachmentTraySpacing\"))"))
        #expect(nativeShim.contains("attachmentChipListLayout->setSpacing(styleInt(style, \"attachmentTrayChipSpacing\"))"))
        ...
        #expect(nativeShim.contains("const int dropTargetPadding = styleInt(style, \"dropTargetPadding\")"))
        ...
        #expect(nativeShim.contains("dropLayout->setSpacing(styleInt(style, \"attachmentInputSpacing\"))"))
        #expect(!nativeShim.contains("const int attachmentInputHorizontalPadding = styleInt(style, \"attachmentInputHorizontalPadding\")"))
        #expect(!nativeShim.contains("const int attachmentInputVerticalPadding = styleInt(style, \"attachmentInputVerticalPadding\")"))
        #expect(!nativeShim.contains("dropLayout->setContentsMargins(10, 7, 10, 7)"))
        #expect(!nativeShim.contains("dropLayout->setSpacing(8)"))
        #expect(nativeShim.contains("styleInt(style, \"headerTitleWidth\")"))
        #expect(nativeShim.contains("statusLayout->setSpacing(styleInt(style, \"statusRowSpacing\"))"))
        #expect(nativeShim.contains("statusText->setFixedWidth(styleInt(style, \"statusTextWidth\"))"))
        #expect(nativeShim.contains("const int statusDotSize = styleInt(style, \"statusDotSize\")"))
        #expect(nativeShim.contains("statusDot->setFixedSize(statusDotSize, statusDotSize)"))
        #expect(nativeShim.contains("headerLayout->setSpacing(styleInt(style, \"headerSpacing\"))"))
        #expect(nativeShim.contains("titleLayout->setSpacing(styleInt(style, \"headerTitleSpacing\"))"))
        #expect(nativeShim.contains("messageLayout->setSpacing(styleInt(style, \"messageSpacing\"))"))
        #expect(nativeShim.contains("QWidget *loadingRowWidget(const QString &status, const QJsonObject &style)"))
        #expect(nativeShim.contains("layout->setContentsMargins(0, styleInt(style, \"loadingTopPadding\"), 0, 0)"))
        #expect(nativeShim.contains("layout->setSpacing(styleInt(style, \"loadingRowSpacing\"))"))
        #expect(nativeShim.contains("const int spinnerSize = styleInt(style, \"loadingSpinnerSize\")"))
        ...
        #expect(nativeShim.contains("row->setSpacing(styleInt(style, \"messageBubbleRowSpacing\"))"))
        #expect(nativeShim.contains("const int messageBubblePadding = styleInt(style, \"messageBubblePadding\")"))
        #expect(nativeShim.contains("layout->setContentsMargins(\n        messageBubblePadding,\n        messageBubblePadding,\n        messageBubblePadding,\n        messageBubblePadding\n    )"))
        #expect(nativeShim.contains("layout->setSpacing(styleInt(style, \"messageBubbleSpacing\"))"))
        #expect(nativeShim.contains("const int emptyStatePadding = styleInt(style, \"emptyStatePadding\")"))
        #expect(nativeShim.contains("layout->setContentsMargins(\n        emptyStatePadding,\n        emptyStatePadding,\n        emptyStatePadding,\n        emptyStatePadding\n    )"))
        #expect(nativeShim.contains("layout->setSpacing(styleInt(style, \"emptyStateSpacing\"))"))
        #expect(nativeShim.contains("headerLayout->setSpacing(styleInt(style, \"emptyStateHeaderSpacing\"))"))
        #expect(nativeShim.contains("promptList->setSpacing(styleInt(style, \"promptListSpacing\"))"))
        #expect(nativeShim.contains("const int promptButtonWidth = styleInt(style, \"promptButtonWidth\")"))
        #expect(nativeShim.contains("const int promptButtonIconSpacing = styleInt(style, \"promptButtonIconSpacing\")"))
        #expect(nativeShim.contains("const int promptButtonTextWidth = promptButtonWidth - styleInt(style, \"promptButtonTextWidthInset\")"))
        ...
        #expect(nativeShim.contains("button->setMinimumHeight(styleInt(style, \"promptButtonMinHeight\"))"))
        #expect(nativeShim.contains("button->setFixedWidth(promptButtonWidth)"))
        #expect(nativeShim.contains("emptyState->setMaximumWidth(styleInt(style, \"emptyStateMaxWidth\"))"))
        #expect(nativeShim.contains("const QString primaryButtonVerticalPadding = stylePixels(style, \"primaryButtonVerticalPadding\")"))
        #expect(nativeShim.contains("const QString primaryButtonHorizontalPadding = stylePixels(style, \"primaryButtonHorizontalPadding\")"))
        #expect(nativeShim.contains("const QString primaryButtonRadius = stylePixels(style, \"primaryButtonRadius\")"))
        #expect(nativeShim.contains("const QString secondaryButtonVerticalPadding = stylePixels(style, \"secondaryButtonVerticalPadding\")"))
        #expect(nativeShim.contains("const QString secondaryButtonHorizontalPadding = stylePixels(style, \"secondaryButtonHorizontalPadding\")"))
        #expect(nativeShim.contains("const QString secondaryButtonRadius = stylePixels(style, \"secondaryButtonRadius\")"))
        #expect(nativeShim.contains("const QString promptButtonPadding = stylePixels(style, \"promptButtonPadding\")"))
        #expect(nativeShim.contains("const QString promptButtonRadius = stylePixels(style, \"promptButtonRadius\")"))
        #expect(nativeShim.contains("const QString chipRemoveButtonVerticalPadding = stylePixels(style, \"chipRemoveButtonVerticalPadding\")"))
        #expect(nativeShim.contains("const QString chipRemoveButtonHorizontalPadding = stylePixels(style, \"chipRemoveButtonHorizontalPadding\")"))
        #expect(nativeShim.contains("const QString controlPadding = stylePixels(style, \"controlPadding\")"))
        #expect(nativeShim.contains("const QString controlRadius = stylePixels(style, \"controlRadius\")"))
        #expect(nativeShim.contains("const QString composerEditorRadius = stylePixels(style, \"composerEditorRadius\")"))
        #expect(nativeShim.contains("const QString conversationRowRadius = stylePixels(style, \"conversationRowRadius\")"))
        #expect(nativeShim.contains("const QString conversationListItemRadius = stylePixels(style, \"conversationListItemRadius\")"))
        #expect(nativeShim.contains("const QString conversationListItemVerticalMargin = stylePixels(style, \"conversationListItemVerticalMargin\")"))
        #expect(nativeShim.contains("const QString conversationListItemPadding = stylePixels(style, \"conversationListItemPadding\")"))
        #expect(nativeShim.contains("list->setSpacing(styleInt(style, \"conversationListSpacing\"))"))
        #expect(nativeShim.contains("const QString emptyHistoryRadius = stylePixels(style, \"emptyHistoryRadius\")"))
        #expect(nativeShim.contains("const QString messageBubbleRadius = stylePixels(style, \"messageBubbleRadius\")"))
        #expect(nativeShim.contains("const QString attachmentChipRadius = stylePixels(style, \"attachmentChipRadius\")"))
        #expect(nativeShim.contains("const QString markdownQuoteRuleRadius = stylePixels(style, \"markdownQuoteRuleRadius\")"))
        #expect(nativeShim.contains("const QString markdownCodeBlockRadius = stylePixels(style, \"markdownCodeBlockRadius\")"))
        #expect(nativeShim.contains("const QString dropTargetRadius = stylePixels(style, \"dropTargetRadius\")"))
        #expect(nativeShim.contains("const QString rootFontSize = stylePixels(style, \"rootFontSize\")"))
        #expect(nativeShim.contains("const QString appTitleFontSize = stylePixels(style, \"appTitleFontSize\")"))
        #expect(nativeShim.contains("const QString appTitleFontWeight = QString::number(styleInt(style, \"appTitleFontWeight\"))"))
        #expect(nativeShim.contains("const QString captionFontSize = stylePixels(style, \"captionFontSize\")"))
        #expect(nativeShim.contains("const QString sectionTitleFontSize = stylePixels(style, \"sectionTitleFontSize\")"))
        #expect(nativeShim.contains("const QString sectionTitleFontWeight = QString::number(styleInt(style, \"sectionTitleFontWeight\"))"))
        #expect(nativeShim.contains("const QString currentTitleFontSize = stylePixels(style, \"currentTitleFontSize\")"))
        #expect(nativeShim.contains("const QString currentTitleFontWeight = QString::number(styleInt(style, \"currentTitleFontWeight\"))"))
        #expect(nativeShim.contains("const QString messageBodyFontSize = stylePixels(style, \"messageBodyFontSize\")"))
        #expect(nativeShim.contains("const QString markdownHeading1FontSize = stylePixels(style, \"markdownHeading1FontSize\")"))
        #expect(nativeShim.contains("const QString markdownHeading2FontSize = stylePixels(style, \"markdownHeading2FontSize\")"))
        #expect(nativeShim.contains("const QString markdownHeadingFontSize = stylePixels(style, \"markdownHeadingFontSize\")"))
        #expect(nativeShim.contains("const QString markdownHeadingFontWeight = QString::number(styleInt(style, \"markdownHeadingFontWeight\"))"))
        #expect(nativeShim.contains("const QString markdownCodeLanguageFontSize = stylePixels(style, \"markdownCodeLanguageFontSize\")"))
        #expect(nativeShim.contains("const QString markdownCodeFontSize = stylePixels(style, \"markdownCodeFontSize\")"))
        #expect(nativeShim.contains("const QString attachmentNameFontSize = stylePixels(style, \"attachmentNameFontSize\")"))
        #expect(nativeShim.contains("const QString attachmentSizeFontSize = stylePixels(style, \"attachmentSizeFontSize\")"))
        #expect(nativeShim.contains("const QString conversationTitleFontSize = stylePixels(style, \"conversationTitleFontSize\")"))
        #expect(nativeShim.contains("const QString conversationTitleFontWeight = QString::number(styleInt(style, \"conversationTitleFontWeight\"))"))
        #expect(nativeShim.contains("const QString conversationPreviewFontSize = stylePixels(style, \"conversationPreviewFontSize\")"))
        #expect(nativeShim.contains("const QString warningTextFontSize = stylePixels(style, \"warningTextFontSize\")"))
        #expect(nativeShim.contains("const QString chipRemoveButtonFontWeight = QString::number(styleInt(style, \"chipRemoveButtonFontWeight\"))"))
        ...
        #expect(nativeShim.contains("const int composerPadding = styleInt(style, \"composerPadding\")"))
        #expect(nativeShim.contains("composerContent->setMinimumWidth(styleInt(style, \"composerMinWidth\"))"))
        #expect(nativeShim.contains("composerContent->setMaximumWidth(styleInt(style, \"composerMaxWidth\"))"))
        ...
        #expect(nativeShim.contains("composerLayout->setSpacing(styleInt(style, \"composerSpacing\"))"))
        #expect(nativeShim.contains("promptRow->setSpacing(styleInt(style, \"promptRowSpacing\"))"))
        #expect(nativeShim.contains("promptEditor->setMinimumHeight(styleInt(style, \"composerMinHeight\"))"))
        #expect(nativeShim.contains("promptEditor->setMaximumHeight(styleInt(style, \"composerMaxHeight\"))"))
        #expect(!nativeShim.contains("promptEditor->setFixedHeight(styleInt(style, \"composerHeight\"))"))
        ...
        #expect(sharedPrompts.contains("public static let attachmentRemovedEmptyStatus = readyStatus"))
        ...
        #expect(nativeShim.contains("const QString chooseLocalModelStatus = stringValue(payload, \"chooseLocalModelStatus\")"))
        #expect(nativeShim.contains("const QString usingModelStatusPrefix = stringValue(payload, \"usingModelStatusPrefix\")"))
        #expect(nativeShim.contains("const QString newConversationButtonTitle = stringValue(payload, \"newConversationButtonTitle\")"))
        #expect(!nativeShim.contains("chooseLocalModelStatus\", QStringLiteral(\"Choose a local model to begin\")"))
        ...
        #expect(nativeShim.contains("app.setApplicationName(stringValue(payload, \"windowTitle\"))"))
        #expect(nativeShim.contains("window.setWindowTitle(stringValue(payload, \"windowTitle\"))"))
        #expect(nativeShim.contains("stringValue(payload, \"sidebarTitle\")"))
        #expect(nativeShim.contains("stringValue(payload, \"sidebarSubtitle\")"))
        #expect(nativeShim.contains("stringValue(payload, \"endpointLabel\")"))
        #expect(nativeShim.contains("const QString modelLabel = stringValue(payload, \"modelLabel\")"))
        #expect(nativeShim.contains("stringValue(payload, \"conversationsTitle\")"))
        #expect(nativeShim.contains("QPushButton *deleteButton = new QPushButton(stringValue(payload, \"deleteChatTitle\"))"))
        #expect(nativeShim.contains("QPushButton *completionsButton = new QPushButton(stringValue(payload, \"completionsTitle\"))"))
        #expect(nativeShim.contains("QPushButton *shortcutsButton = new QPushButton(stringValue(payload, \"shortcutsTitle\"))"))
        #expect(nativeShim.contains("QPushButton *settingsButton = new QPushButton(stringValue(payload, \"settingsTitle\"))"))
        #expect(nativeShim.contains("QPushButton *refreshButton = new QPushButton(stringValue(payload, \"refreshModelsTitle\"))"))
        #expect(!nativeShim.contains("windowTitle\", QStringLiteral(\"Quill Enchanted\")"))
        #expect(!nativeShim.contains("sidebarTitle\", QStringLiteral(\"Enchanted\")"))
        #expect(!nativeShim.contains("sidebarSubtitle\", QStringLiteral(\"QuillUI Linux preview\")"))
        #expect(!nativeShim.contains("endpointLabel\", QStringLiteral(\"Ollama endpoint\")"))
        #expect(!nativeShim.contains("modelLabel\", QStringLiteral(\"Model\")"))
        #expect(!nativeShim.contains("conversationsTitle\", QStringLiteral(\"Conversations\")"))
        #expect(!nativeShim.contains("deleteChatTitle\", QStringLiteral(\"Delete chat\")"))
        #expect(!nativeShim.contains("completionsTitle\", QStringLiteral(\"Completions\")"))
        #expect(!nativeShim.contains("shortcutsTitle\", QStringLiteral(\"Shortcuts\")"))
        #expect(!nativeShim.contains("settingsTitle\", QStringLiteral(\"Settings\")"))
        #expect(!nativeShim.contains("refreshModelsTitle\", QStringLiteral(\"Refresh models\")"))
        #expect(nativeShim.contains("QPushButton *newConversationButton = new QPushButton(newConversationButtonTitle)"))
        #expect(nativeShim.contains("stringValue(payload, \"completionsPanelSubtitle\")"))
        #expect(nativeShim.contains("stringValue(payload, \"shortcutsPanelSubtitle\")"))
        #expect(nativeShim.contains("stringValue(payload, \"settingsPanelSubtitle\")"))
        ...
        #expect(nativeShim.contains("const QString newConversationTitle = stringValue(payload, \"newConversationTitle\")"))
        #expect(nativeShim.contains("const QString noMessagesYet = stringValue(payload, \"noMessagesYet\")"))
        #expect(nativeShim.contains("const QString userRoleLabel = stringValue(payload, \"userRoleLabel\")"))
        #expect(nativeShim.contains("const QString assistantRoleLabel = stringValue(payload, \"assistantRoleLabel\")"))
        #expect(nativeShim.contains("const QString systemRoleLabel = stringValue(payload, \"systemRoleLabel\")"))
        ...
        #expect(nativeShim.contains("layout->setSpacing(styleInt(style, \"markdownListItemSpacing\"))"))
        #expect(nativeShim.contains("markerLabel->setFixedWidth(styleInt(style, \"markdownNumberWidth\"))"))
        #expect(nativeShim.contains("const int verticalPadding = styleInt(style, \"markdownQuoteVerticalPadding\")"))
        #expect(nativeShim.contains("layout->setContentsMargins(0, verticalPadding, 0, verticalPadding)"))
        #expect(nativeShim.contains("layout->setSpacing(styleInt(style, \"markdownQuoteSpacing\"))"))
        #expect(nativeShim.contains("rule->setFixedWidth(styleInt(style, \"markdownQuoteRuleWidth\"))"))
        #expect(nativeShim.contains("const int codeBlockPadding = styleInt(style, \"markdownCodeBlockPadding\")"))
        #expect(nativeShim.contains("layout->setContentsMargins(codeBlockPadding, codeBlockPadding, codeBlockPadding, codeBlockPadding)"))
        #expect(nativeShim.contains("layout->setSpacing(styleInt(style, \"markdownCodeBlockSpacing\"))"))
        ...
        #expect(nativeShim.contains("layout->setSpacing(styleInt(style, \"markdownBlockSpacing\"))"))
        ...
        #expect(nativeShim.contains("stringValue(payload, \"noModelsTitle\")"))
        ...
        #expect(nativeShim.contains("const QString statusDotSize = stylePixels(style, \"statusDotSize\")"))
        #expect(nativeShim.contains("const QString statusDotRadius = stylePixels(style, \"statusDotRadius\")"))
        ...
        #expect(nativeShim.contains("stringValue(payload, \"clearAllTitle\")"))
        #expect(!nativeShim.contains("stringValue(payload, \"clearAllTitle\", QStringLiteral(\"Clear all\"))"))
        #expect(nativeShim.contains("QFrame *emptyHistoryWidget(const QString &title, const QString &subtitle, const QJsonObject &style)"))
        #expect(nativeShim.contains("const int emptyHistoryPadding = styleInt(style, \"emptyHistoryPadding\")"))
        #expect(nativeShim.contains("layout->setContentsMargins(\n        emptyHistoryPadding,\n        emptyHistoryPadding,\n        emptyHistoryPadding,\n        emptyHistoryPadding\n    )"))
        #expect(nativeShim.contains("layout->setSpacing(styleInt(style, \"emptyHistorySpacing\"))"))
        ...
        #expect(!nativeShim.contains("layout->setSpacing(8)"))
        #expect(nativeShim.contains("stringValue(payload, \"emptyHistoryTitle\")"))
        #expect(nativeShim.contains("stringValue(payload, \"emptyHistorySubtitle\")"))
        ...
        #expect(nativeShim.contains("stringValue(payload, \"attachmentPlaceholder\")"))
        #expect(!nativeShim.contains("QStringLiteral(\"Image path or drop files here\")"))
        #expect(nativeShim.contains("stringValue(payload, \"attachTitle\")"))
        #expect(!nativeShim.contains("stringValue(payload, \"attachTitle\", QStringLiteral(\"Attach\"))"))
        #expect(nativeShim.contains("stringValue(payload, \"clearAttachmentsTitle\")"))
        ...
        #expect(nativeShim.contains("stringValue(payload, \"attachmentsTitle\")"))
        ...
        #expect(nativeShim.contains("stringValue(payload, \"dropTargetTitle\")"))
        ...
        #expect(nativeShim.contains("removeAttachmentButton->setFixedWidth(styleInt(style, \"attachmentRemoveButtonWidth\"))"))
        ...
        #expect(nativeShim.contains("return styleInt(style, \"actionButtonIconSize\")"))
        ...
        #expect(nativeShim.contains("sendButton->setMinimumWidth(styleInt(style, \"composerSendButtonMinWidth\"))"))
        ...
        #expect(nativeShim.contains("stringValue(payload, \"composerPlaceholder\")"))
        #expect(!nativeShim.contains("QStringLiteral(\"Ask a local model...\")"))
        #expect(nativeShim.contains("stringValue(payload, \"emptyStateTitle\")"))
        #expect(!nativeShim.contains("QStringLiteral(\"Ask your local model\")"))
        #expect(nativeShim.contains("stringValue(payload, \"emptyStateSubtitle\")"))
        #expect(!nativeShim.contains("QStringLiteral(\"This is the first QuillUI Enchanted checkpoint: local Swift UI, Ollama chat, and QuillData history.\")"))
        ...
        #expect(nativeShim.contains("requiredWindowSize(payload, \"minimumWidth\", \"minimumHeight\")"))
        #expect(nativeShim.contains("clampedDefaultWindowSize(payload, minimumWindowSize)"))
        #expect(!nativeShim.contains("QSize resolvedMinimumWindowSize"))
        #expect(!nativeShim.contains("QSize resolvedDefaultWindowSize"))
        #expect(nativeShim.contains("QString stylePixels(const QJsonObject &style, const char *key)"))
        #expect(nativeShim.contains("int styleInt(const QJsonObject &style, const char *key)"))
        #expect(!nativeShim.contains("intValue(style, \""))
        #expect(!nativeShim.contains("cssPixels(style, \""))
        #expect(!nativeShim.contains("styleValue(style, \"canvasColor\","))
        #expect(!nativeShim.contains("QuillQtWidgets::minimumWindowSize(payload"))
        #expect(!nativeShim.contains("QuillQtWidgets::defaultWindowSize(payload"))
