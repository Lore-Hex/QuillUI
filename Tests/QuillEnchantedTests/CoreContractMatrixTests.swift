...
struct CoreContractMatrixTests {
    ...
    func enchantedQtNativeTargetContracts() throws {
        ...
        #expect(runtime.contains("attachmentsClearedStatus: \"Attachments cleared\""))
        ...
        #expect(macOSRootView.contains("Text(\"Drop image files to attach\")"))
        ...
        #expect(runtime.contains("dropTargetTitle: \"Drop image files to attach\""))
