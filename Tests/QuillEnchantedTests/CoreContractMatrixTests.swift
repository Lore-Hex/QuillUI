...
struct CoreContractMatrixTests {
    ...
    func enchantedQtNativeTargetContracts() throws {
        ...
        #expect(nativeShim.contains(".arg(statusDotSize, statusDotRadius, success, warning, canvas)"))
        ...
        #expect(nativeShim.contains("QLabel#conversationPreview { color: %4; font-size: 12px; }"))
        #expect(nativeShim.contains("QLabel#conversationPreview[active=\"true\"] { color: %1; }"))
        #expect(!nativeShim.contains("QLabel#conversationPreview { color: %5; font-size: 12px; }"))
