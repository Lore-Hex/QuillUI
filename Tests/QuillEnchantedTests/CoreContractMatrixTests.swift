...
struct CoreContractMatrixTests {
    ...
    func enchantedQtNativeTargetContracts() throws {
        ...
        #expect(nativeShim.contains("stringValue(conversation, \"lastMessage\", noMessagesYet)"))
        #expect(nativeShim.contains("conversationRowWidget(\n            conversation,\n            style,\n            newConversationTitle,\n            noMessagesYet\n        )"))
        ...
        #expect(nativeShim.contains("QLabel *promptIcon = label(promptCardPrefix().trimmed(), QStringLiteral(\"promptButtonIcon\"))"))
        ...
        #expect(nativeShim.contains("QLabel *attachmentIcon = new QLabel()"))
        #expect(nativeShim.contains("attachmentIcon->setObjectName(QStringLiteral(\"attachmentChipIcon\"))"))
        #expect(nativeShim.contains("attachmentChipIcon().pixmap(attachmentIconSize, attachmentIconSize)"))
        ...
        #expect(macOSRootView.contains("EnchantedVisualMetrics.primaryButtonIconSpacing"))
        #expect(nativeShim.contains("newChatButton->setIcon(newChatButtonIcon())"))
        ...
        #expect(nativeShim.contains("applyButtonIconSize(newChatButton, style)"))
