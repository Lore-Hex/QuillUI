...
struct CoreContractMatrixTests {
    ...
    func enchantedQtNativeTargetContracts() throws {
        ...
        #expect(nativeShim.contains("sendButton->setEnabled(isLoading || hasTrimmedText(promptEditor) || !pendingAttachmentSummary.isEmpty())"))
        ...
        #expect(nativeShim.contains("auto requestHistoryAction ="))
        #expect(nativeShim.contains("requestHistoryAction(QStringLiteral(\"newConversation\"), QString())"))
        #expect(nativeShim.contains("requestHistoryAction(QStringLiteral(\"deleteConversation\"), deletedConversationID)"))
        #expect(nativeShim.contains("requestHistoryAction(QStringLiteral(\"deleteAllConversations\"), QString())"))
