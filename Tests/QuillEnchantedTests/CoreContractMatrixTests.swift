...
struct CoreContractMatrixTests {
    ...
    func enchantedQtNativeTargetContracts() throws {
        ...
        #expect(macOSRootView.contains("Image(systemName: \"star.fill\")"))
        ...
        #expect(nativeShim.contains("QLabel *promptIcon = iconLabel(promptButtonIcon(), QStringLiteral(\"promptButtonIcon\"), style)"))
        ...
        #expect(nativeShim.contains("QIcon promptButtonIcon()"))
