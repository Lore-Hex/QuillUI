...
struct CoreContractMatrixTests {
    ...
    func enchantedQtNativeTargetContracts() throws {
        ...
        #expect(runtime.contains("rootFontSize: 14"))
        #expect(runtime.contains("appTitleFontSize: 26"))
        #expect(runtime.contains("appTitleFontWeight: 700"))
        #expect(runtime.contains("captionFontSize: 12"))
        #expect(runtime.contains("sectionTitleFontSize: 15"))
        #expect(runtime.contains("sectionTitleFontWeight: 700"))
        #expect(runtime.contains("currentTitleFontSize: 20"))
        #expect(runtime.contains("currentTitleFontWeight: 650"))
        #expect(runtime.contains("messageBodyFontSize: 14"))
        #expect(runtime.contains("markdownHeading1FontSize: 17"))
        #expect(runtime.contains("markdownHeading2FontSize: 15"))
        #expect(runtime.contains("markdownHeadingFontSize: 14"))
        #expect(runtime.contains("markdownHeadingFontWeight: 650"))
        #expect(runtime.contains("markdownCodeLanguageFontSize: 11"))
        #expect(runtime.contains("markdownCodeFontSize: 13"))
        #expect(runtime.contains("attachmentNameFontSize: 12"))
        #expect(runtime.contains("attachmentSizeFontSize: 11"))
        #expect(runtime.contains("conversationTitleFontSize: 15"))
        #expect(runtime.contains("conversationTitleFontWeight: 700"))
        #expect(runtime.contains("conversationPreviewFontSize: 12"))
        #expect(runtime.contains("warningTextFontSize: 12"))
        #expect(runtime.contains("chipRemoveButtonFontWeight: 700"))
