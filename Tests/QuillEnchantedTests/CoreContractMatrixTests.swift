...
struct CoreContractMatrixTests {
    ...
    func enchantedQtNativeTargetContracts() throws {
        ...
        #expect(nativeShim.contains("stringValue(payload, \"attachmentsClearedStatus\", QStringLiteral(\"Attachments cleared\"))"))
        #expect(nativeShim.contains("stringValue(payload, \"attachmentRemovedEmptyStatus\", QStringLiteral(\"Ready\"))"))
