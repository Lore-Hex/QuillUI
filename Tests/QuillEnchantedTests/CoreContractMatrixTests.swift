...
struct CoreContractMatrixTests {
    ...
    func enchantedQtNativeTargetContracts() throws {
        ...
        #expect(nativeShim.contains("QLabel#messageUserRole { color: %3; font-size: 12px; }"))
        #expect(nativeShim.contains("QFrame#emptyHistory { background: %4; border: 1px solid %5; border-radius: 8px; }"))
        #expect(nativeShim.contains("QFrame#messageAssistant { background: %4; border: 1px solid %5; border-radius: 10px; }"))
        #expect(nativeShim.contains("QFrame#messageSystem { background: %6; border: 1px solid %7; border-radius: 10px; }"))
        #expect(nativeShim.contains("QFrame#messageUser { background: %8; border: 1px solid %7; border-radius: 10px; }"))
        #expect(nativeShim.contains("QFrame#attachmentChip { background: %4; border: 1px solid %5; border-radius: 8px; }"))
        ...
        #expect(nativeShim.contains("QPushButton#chipRemoveButton { background: transparent; color: %1; border: 0; padding: %2 %3; font-weight: 700; }"))
        ...
        #expect(nativeShim.contains("border-radius: %9;"))
        #expect(!nativeShim.contains("min-width: 9px; max-width: 9px; min-height: 9px; max-height: 9px; border-radius: 4px;"))
        #expect(nativeShim.contains(".arg(selected, ink, card, success, warning, canvas, primary, statusDotSize, statusDotRadius)"))
        ...
        #expect(nativeShim.contains("QFrame#conversationRow[active=\"true\"] { background: %7; }"))
        ...
        #expect(nativeShim.contains("QFrame#dropTarget { background: %1; border: 1px solid %2; border-radius: 8px; }"))
