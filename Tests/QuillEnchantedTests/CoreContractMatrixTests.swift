...
struct CoreContractMatrixTests {
    ...
    func enchantedQtNativeTargetContracts() throws {
        ...
        expectContains(nativeShim, "const QString noMessagesYet = payloadString(payload, \"noMessagesYet\")")
        ...
        expectContains(nativeShim, "modelStatusText(payloadString(payload, \"selectedModel\"), chooseLocalModelStatus, usingModelStatusPrefix)")
        ...
        expectContains(nativeShim, "payloadString(payload, \"dropTargetTitle\")")
