...
struct UpstreamCompatibilityTests {
    ...
    func compilesPortingSurface() {
        ...
        #expect(QuillSystemSymbol.compatibleName("paperplane.fill") == "paperplane.fill")
        #expect(QuillSystemSymbol.compatibleName("photo.fill") == "photo.fill")
        #expect(QuillSystemSymbol.compatibleName("keyboard") == "keyboard")
        #expect(QuillSystemSymbol.compatibleName("keyboard.fill") == "keyboard.fill")
        #expect(QuillSystemSymbol.compatibleName("waveform") == "waveform")
        #expect(QuillSystemSymbol.compatibleName("xmark") == "xmark.circle.fill")
    ...
    func quillControlViewTreesMaterializeNestedContent() {
        ...
        #expect(QuillSystemSymbol.compatibleName("lightbulb.circle.fill") == "lightbulb.circle.fill")
        #expect(QuillSystemSymbol.compatibleName("textformat.abc") == "textformat.abc")
        #expect(QuillSystemSymbol.compatibleName("keyboard.fill") == "keyboard.fill")
        #expect(QuillSystemSymbol.compatibleName("xmark") == "xmark.circle.fill")
        #expect(QuillSystemSymbol.compatibleName("x.circle") == "xmark.circle.fill")
        #expect(QuillSystemSymbol.compatibleName("x.circle.fill") == "xmark.circle.fill")
