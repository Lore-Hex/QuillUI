...
public enum HTMLEntities {
    ...
    private static let replacements: [(String, String)] = [
        ...
        ("&middot;", "\u{00B7}"),
        ("&bull;", "\u{2022}"),
        // Latin accented letters — common in author names +
        // international feed titles. These are the entities a
        // human typing names like "José" / "García" in a CMS
        // typically ends up with after the editor's auto-escape.
