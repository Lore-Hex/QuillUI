...
// `@AppStorage` for the vendored IceCubes targets now resolves to the ONE
// canonical implementation in QuillSwiftUICompatibility (AppStorage.swift),
// visible through the SwiftUI shim re-export. The IceCubes-scoped twin that
// lived here predates that move and made `AppStorage` ambiguous for every
// IceCubes file once both were co-visible (Env/UserPreferences.swift). The
// protocol name survives for any straggler references:
public typealias IceCubesAppStorageValue = QuillAppStorageValue
