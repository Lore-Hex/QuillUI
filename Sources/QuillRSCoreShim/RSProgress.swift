...
//  only, so it compiles unchanged on macOS and Linux. ProgressInfo /
//  ProgressInfoReporter / RSProgress back the refresh-progress reporting the
//  Account module's CombinedRefreshProgress and the app refresh UI use.
//
