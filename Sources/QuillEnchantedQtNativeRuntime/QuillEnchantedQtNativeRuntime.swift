...
struct QuillEnchantedQtSnapshot: Codable, Sendable {
    ...
    struct Style: Codable, Sendable {
        ...
        var promptGridColumns: Int
        var promptGridSpacing: Int
        var promptCardWidth: Int
        var promptCardHeight: Int
        var promptGridWidth: Int
    ...
    static let preview = QuillEnchantedQtSnapshot(
        ...
        completionsStatus: EnchantedCopy.completionsStatus,
        shortcutsStatus: EnchantedCopy.shortcutsStatus,
        settingsStatus: EnchantedCopy.settingsStatus,
