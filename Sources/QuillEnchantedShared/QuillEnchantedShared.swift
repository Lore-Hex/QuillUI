...
public enum EnchantedVisualMetrics {
    ...
    public static let messageSpacing = 8
    public static let messageRowHorizontalPadding = 10
    public static let messageRowVerticalPadding = 10
    public static let messageBubbleRowSpacing = 8
    ...
    public static let messageAvatarSize = 24
    public static let messageAvatarBaselineOffset = 6
    public static let userMessageBubblePadding = 16
    public static let userMessageBubbleRadius = 25
