...
| Upstream and vendored code | `.upstream/*`, `third_party/*` | Real source inputs and pinned external compatibility runtimes. | Vendored code is either fetched or pinned intentionally. Changes need a clear upstreaming or patch-management story. |
