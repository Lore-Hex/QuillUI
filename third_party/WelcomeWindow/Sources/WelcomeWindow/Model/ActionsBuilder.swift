...
public enum ActionsBuilder {
    ...
    @MainActor public static func buildBlock() -> WelcomeActions {
        .none
    }
    ...
    @MainActor public static func buildBlock<V1: View, V2: View>(_ view1: V1, _ view2: V2) -> WelcomeActions {
    ...
    @MainActor public static func buildBlock<V1: View, V2: View, V3: View>(
